...
interface CreateBookingInput {
  ...
  // [TravelerDetail]   name: string
  // [TravelerDetail]   phone: string
  // [TravelerDetail]   age: number
  // [TravelerDetail]   gender: 'MALE' | 'FEMALE' | 'OTHER'
  // [TravelerDetail]   isPrimary: boolean
  // [TravelerDetail]   emergencyContactName?: string
