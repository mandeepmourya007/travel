...
While we verify organizers and process payments securely, we are not a party to the contract between you and the trip organizer. You transact with organizers at your own risk, subject to the protections we provide.`,
  },
  {
    id: 'accounts',
...
Your payment is processed securely through our payment partners. Payout timing to the organizer follows the applicable payment partner's settlement schedule and our refund policy, which protects you in the event of trip cancellation or non-delivery of promised services.
...
• Organizer Cancellations: If an organizer cancels a trip for any reason, all travelers receive a full refund within 5–7 business days.
...
• Attempting to make off-platform payments to bypass our fees.
...
• Processing bookings and managing payments via our payment partners
...
export const organizerCancellationText = {
  ...
  body: `If the organizer cancels a trip for any reason — weather, insufficient bookings, operational issues, or any other cause — every traveler booked on that trip receives a 100% refund. No deductions. No processing fees.`,
  refundTimingNote: `A full refund is initiated automatically — credited to your original payment method within 5–7 business days, with no deductions or processing fees.`,
...
export const organizerRuleGroups: RuleGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'All travelers on a cancelled trip will receive a full refund regardless of the cancellation policy.',
  ...
  },
  {
    ...
    items: [
      `Accepting payments outside of the ${APP_NAME} platform to circumvent platform fees.`,
...
In such events, our Cancellation & Refund Policy governs what refunds are available. We will make every reasonable effort to communicate with affected users promptly and facilitate refunds where applicable.`,
  },
  {
...
• You may refuse participation to a traveler who does not meet stated requirements, provided you notify ${APP_NAME} support promptly so a refund can be processed.`,
  ...
  },
  {
    ...
    content: `6.1 Payment Model
All traveler payments are processed securely via our payment partners. Payout timing to organizers follows the applicable payment partner's settlement schedule and this Agreement; it is not guaranteed to occur only after trip completion for every payment method.
...
If you cancel a trip for any reason, all booked travelers are entitled to a full refund. You must notify ${APP_NAME} and all travelers at least 48 hours before the scheduled departure when a cancellation is anticipated.
...
export const faqs: FaqItem[] = [
  {
    ...
    answer: `When you book a trip on ${APP_NAME}, your payment is processed securely through our payment partners. If the trip is cancelled by the organizer, you receive an automatic full refund — no questions asked, no processing fees. This protects you from fraud and ensures organizers are accountable for delivering on their promises.`,
  },
  {
