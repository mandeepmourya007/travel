...
async function upsertTrip(
  ...
  const trip = await prisma.trip.upsert({
    ...
    update: {
      ...
      status: rest.status, acceptingBookings: rest.acceptingBookings,
      bookingsPausedBy: rest.bookingsPausedBy, bookingsPausedReason: rest.bookingsPausedReason,
    },
  })
...
async function seedUpcomingTrips(deps: Record<string, { id: string }>) {
  ...
  const tripU1 = await upsertTrip('kasol-kheerganga-trek-jun-2026', {
      ...
      startDate: d(2026, 9, 5), endDate: d(2026, 9, 9), bookingDeadline: d(2026, 8, 30),
      pricePerPerson: 9499, earlyBirdPrice: 8499, earlyBirdDeadline: d(2026, 8, 20),
      ...
      status: 'ACTIVE', acceptingBookings: false, bookingsPausedBy: 'ADMIN', bookingsPausedReason: 'Bookings closed by admin',
    }, [
  ...
  const tripU2 = await upsertTrip('spiti-valley-circuit-jun-2026', {
      ...
      startDate: d(2026, 9, 12), endDate: d(2026, 9, 19), bookingDeadline: d(2026, 9, 5),
      pricePerPerson: 14999, earlyBirdPrice: 12999, earlyBirdDeadline: d(2026, 8, 25),
  ...
  const tripU3 = await upsertTrip('udaipur-city-of-lakes-apr-2026', {
      ...
      startDate: d(2026, 8, 22), endDate: d(2026, 8, 25), bookingDeadline: d(2026, 8, 16),
      pricePerPerson: 9999, earlyBirdPrice: 8999, earlyBirdDeadline: d(2026, 8, 8),
  ...
  const tripU4 = await upsertTrip('coorg-coffee-plantation-apr-2026', {
      ...
      startDate: d(2026, 9, 19), endDate: d(2026, 9, 22), bookingDeadline: d(2026, 9, 14),
      pricePerPerson: 10999, earlyBirdPrice: 9499, earlyBirdDeadline: d(2026, 9, 1),
  ...
  const tripU5 = await upsertTrip('varanasi-spiritual-immersion-may-2026', {
      ...
      startDate: d(2026, 10, 9), endDate: d(2026, 10, 12), bookingDeadline: d(2026, 10, 3),
      pricePerPerson: 8999, earlyBirdPrice: 7999, earlyBirdDeadline: d(2026, 9, 20),
  ...
  const tripU6 = await upsertTrip('andaman-beach-scuba-jun-2026', {
      ...
      startDate: d(2026, 10, 16), endDate: d(2026, 10, 21), bookingDeadline: d(2026, 10, 8),
      pricePerPerson: 14499, earlyBirdPrice: 12499, earlyBirdDeadline: d(2026, 9, 25),
  ...
  const tripU7 = await upsertTrip('goa-beach-escape-apr-2026', {
      ...
      startDate: d(2026, 8, 14), endDate: d(2026, 8, 18), bookingDeadline: d(2026, 8, 9),
      pricePerPerson: 6999, earlyBirdPrice: 5999, earlyBirdDeadline: d(2026, 8, 1),
  ...
  const tripU8 = await upsertTrip('lonavala-trek-camping-apr-2026', {
      ...
      startDate: d(2026, 8, 22), endDate: d(2026, 8, 24), bookingDeadline: d(2026, 8, 19),
      pricePerPerson: 2499,
  ...
  const tripU9 = await upsertTrip('manali-summer-adventure-jun-2026', {
      ...
      startDate: d(2026, 9, 25), endDate: d(2026, 10, 1), bookingDeadline: d(2026, 9, 19),
      pricePerPerson: 11999, earlyBirdPrice: 10499, earlyBirdDeadline: d(2026, 9, 10),
  ...
  const tripU10 = await upsertTrip('ladakh-bike-expedition-may-2026', {
      ...
      startDate: d(2026, 9, 10), endDate: d(2026, 9, 19), bookingDeadline: d(2026, 9, 1),
      pricePerPerson: 22999, earlyBirdPrice: 19999, earlyBirdDeadline: d(2026, 8, 20),
  ...
  const tripU11 = await upsertTrip('rishikesh-rafting-bungee-may-2026', {
      ...
      startDate: d(2026, 10, 23), endDate: d(2026, 10, 25), bookingDeadline: d(2026, 10, 19),
      pricePerPerson: 4999,
  ...
  const tripU12 = await upsertTrip('jaipur-royal-heritage-food-trail-may-2026', {
      ...
      startDate: d(2026, 11, 6), endDate: d(2026, 11, 9), bookingDeadline: d(2026, 11, 1),
      pricePerPerson: 7499, earlyBirdPrice: 6499, earlyBirdDeadline: d(2026, 10, 20),
  ...
  console.log('  ✓ Created 12 upcoming trips (Jan-Jun 2026, ₹2.5K-23K range)')
...
async function seedBulkTrips(deps: Record<string, { id: string }>, travelers: { id: string }[]) {
  ...
  async function mk(o: BulkOpts) {
    ...
    const trip = await upsertTrip(o.slug, {
      ...
      acceptingBookings: false, bookingsPausedBy: 'ADMIN' as const, bookingsPausedReason: 'Bookings closed by admin',
      inclusions: o.incl, exclusions: o.excl,
