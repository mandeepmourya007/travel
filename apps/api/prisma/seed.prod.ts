...
async function upsertOrgProfile(userId: string, data: Omit<Prisma.OrganizerProfileCreateInput, 'user'>) {
  return prisma.organizerProfile.upsert({
    ...
    update: { businessName: data.businessName, slug: data.slug, description: data.description, commissionRate: data.commissionRate, razorpayAccountId: data.razorpayAccountId, cashfreeVendorId: data.cashfreeVendorId },
  })
}
...
async function main() {
  ...
  const org1User = await upsertUser('rajesh@desiwanderers.in', { name: 'Rajesh Khandelwal', passwordHash, role: 'ORGANIZER', phone: '+919820145678', emailVerified: true, phoneVerified: true, avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=RK' })
  const org2User = await upsertUser('deepa@peaksandshore.in', { name: 'Deepa Naidu', passwordHash, role: 'ORGANIZER', phone: '+919845098765', emailVerified: true, phoneVerified: true, avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=DN' })
  const org3User = await upsertUser('arjun@nomadictrails.in', { name: 'Arjun Malhotra', passwordHash, role: 'ORGANIZER', phone: '+919871023456', emailVerified: true, phoneVerified: true, avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=AM' })
  const org4User = await upsertUser('priya@rucksackbharat.com', { name: 'Priya Shinde', passwordHash, role: 'ORGANIZER', phone: '+919890123400', emailVerified: true, phoneVerified: true, avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=PS' })
  const org5User = await upsertUser('vikram@sahyadritrekkers.com', { name: 'Vikram Deshpande', passwordHash, role: 'ORGANIZER', phone: '+919823456700', emailVerified: true, avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=VD' })
  const org6User = await upsertUser('neha@budgetyatris.in', { name: 'Neha Grover', passwordHash, role: 'ORGANIZER', phone: '+919812345600', emailVerified: true, avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=NG' })
  const org7User = await upsertUser('kavya@shewandersindia.com', { name: 'Kavya Menon', passwordHash, role: 'ORGANIZER', phone: '+919845671230', emailVerified: true, phoneVerified: true, avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=KN' })
  const org8User = await upsertUser('rahul@corptrips.in', { name: 'Rahul Kulkarni', passwordHash, role: 'ORGANIZER', phone: '+919867453210', emailVerified: true, phoneVerified: true, avatarUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=RK' })
  ...
  console.log('  📧 Organizers:  rajesh@desiwanderers.in, deepa@peaksandshore.in, arjun@nomadictrails.in, priya@rucksackbharat.com')
  console.log('  📧 Pending:     vikram@sahyadritrekkers.com')
  console.log('  📧 Rejected:    neha@budgetyatris.in')
...
async function seedCompletedTrips(deps: Record<string, { id: string }>) {
  ...
  const tripC1 = await upsertTrip('goa-beach-carnival-jan-2026', {
      ...
      pricePerPerson: 6499, earlyBirdPrice: 5499, earlyBirdDeadline: d(2026, 1, 3),
      ...
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432075/seed/trips/trip-goa-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432075/seed/trips/trip-goa-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243413/seed/trips/cn9wpqfkp8xhhkxrqv0i.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243415/seed/trips/vadkycd3rwfui92wk9qn.jpg'],
  ...
  const tripC2 = await upsertTrip('manali-snow-adventure-feb-2026', {
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432079/seed/trips/trip-manali-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432079/seed/trips/trip-manali-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243416/seed/trips/nozdq6aqn3v4eziecuyl.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243417/seed/trips/n2lpqyri7nbedmatwbt2.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripC3 = await upsertTrip('rishikesh-rafting-camping-feb-2026', {
      ...
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432081/seed/trips/trip-rishikesh-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432081/seed/trips/trip-rishikesh-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243419/seed/trips/bpzpf2f5cruehbxc6viu.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243421/seed/trips/pwrtbuuwfkzimanflj4k.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripC4 = await upsertTrip('jaipur-heritage-experience-mar-2026', {
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432076/seed/trips/trip-jaipur-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432077/seed/trips/trip-jaipur-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243423/seed/trips/hg0zfjsgl8dj0skqzmpv.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243424/seed/trips/lecgtowcobbog0rzxzkm.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripC5 = await upsertTrip('ladakh-bike-expedition-jan-2026', {
      ...
      startDate: d(2026, 1, 15), endDate: d(2026, 1, 24),
      pricePerPerson: 24999, earlyBirdPrice: 21999, earlyBirdDeadline: d(2026, 1, 5),
      ...
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243425/seed/trips/ynfo0locqhmcxhycmun2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243428/seed/trips/msyoo0rv6rlyrligfogz.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
  })
  ...
  const tripC6 = await upsertTrip('hampi-ruins-culture-walk-jan-2026', {
      ...
      cancellationPolicy: 'FLEXIBLE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243430/seed/trips/tslj6vvc0ih4xylurntv.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243432/seed/trips/jr7jkfainrahzhpsbxmv.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
  })

  const tripC7 = await upsertTrip('rajmachi-fort-trek-jan-2026', {
      organizerId: org4.id, destinationId: lonavala.id,
      title: 'Rajmachi Fort Trek — 1N/2D',
      tripType: 'TREKKING', bookingMode: 'INSTANT',
      description: 'Trek through the Western Ghats to historic Rajmachi Fort. Misty valleys, scenic ridgelines, night camping near the fort with Maharashtrian food. The quintessential Sahyadri trekking experience.',
      itinerary: [
        { day: 1, title: 'Trek to Rajmachi Fort', description: 'Morning drive, trek through scenic trails.', activities: [{ title: 'Pune pickup', time: '5:30 AM' }, { title: 'Trek start from Kondivade', time: '8:00 AM' }, { title: 'Waterfall stops', time: '10:00 AM' }, { title: 'Arrive Rajmachi village', time: '12:30 PM' }, { title: 'Fort exploration', time: '3:00 PM' }, { title: 'Bonfire & dinner', time: '7:30 PM' }] },
      ...
      startDate: d(2026, 1, 13), endDate: d(2026, 1, 15),
      pricePerPerson: 1899,
      ...
      cancellationPolicy: 'FLEXIBLE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243433/seed/trips/mvsevjv4plu2ytrcahyc.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripC8 = await upsertTrip('meghalaya-living-root-bridges-mar-2026', {
      ...
      cancellationPolicy: 'STRICT',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243435/seed/trips/sbvmlcctptoippek3jz3.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243437/seed/trips/glivpzcfsbsyexx29108.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
  })

  console.log('  ✓ Created 8 completed trips (Jan-Mar 2026)')
...
async function seedUpcomingTrips(deps: Record<string, { id: string }>) {
  ...
  const tripU1 = await upsertTrip('kasol-kheerganga-trek-jun-2026', {
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432077/seed/trips/trip-kasol-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432079/seed/trips/trip-kasol-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243439/seed/trips/apxyfaxa6ujnog0i5dyj.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243442/seed/trips/gh3qpj5qka2my9qk6ogq.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU2 = await upsertTrip('spiti-valley-circuit-jun-2026', {
      ...
      cancellationPolicy: 'STRICT',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432081/seed/trips/trip-spiti-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432082/seed/trips/trip-spiti-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243443/seed/trips/yx0eqw0kwot4glcgy562.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243445/seed/trips/sssmjyiwjzoe13hsn00z.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
  })

  const tripU3 = await upsertTrip('udaipur-city-of-lakes-apr-2026', {
      ...
      startDate: d(2026, 4, 3), endDate: d(2026, 4, 6), bookingDeadline: d(2026, 3, 28),
      pricePerPerson: 9999, earlyBirdPrice: 8999, earlyBirdDeadline: d(2026, 3, 15),
      ...
      exclusions: ['Train/flight tickets', 'Lunch', 'Shopping', 'Travel insurance'],
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432082/seed/trips/trip-udaipur-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432082/seed/trips/trip-udaipur-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243447/seed/trips/bgypvmikg5gfjvveapw4.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243448/seed/trips/yzcpolhrz6t0jgmyxnem.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU4 = await upsertTrip('coorg-coffee-plantation-apr-2026', {
      ...
      startDate: d(2026, 4, 10), endDate: d(2026, 4, 13), bookingDeadline: d(2026, 4, 5),
      pricePerPerson: 10999, earlyBirdPrice: 9499, earlyBirdDeadline: d(2026, 3, 25),
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432074/seed/trips/trip-coorg-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432075/seed/trips/trip-coorg-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243449/seed/trips/oz4c9xk7wxlfbet1ayye.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243451/seed/trips/lyxt8zgkpltfgxzndixa.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU5 = await upsertTrip('varanasi-spiritual-immersion-may-2026', {
      ...
      startDate: d(2026, 5, 7), endDate: d(2026, 5, 10), bookingDeadline: d(2026, 5, 2),
      pricePerPerson: 8999, earlyBirdPrice: 7999, earlyBirdDeadline: d(2026, 4, 20),
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432084/seed/trips/trip-varanasi-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432084/seed/trips/trip-varanasi-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243453/seed/trips/yyyldfoa9hbslcuyblu1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243455/seed/trips/r4njcwyzvhqpwzqlmbyq.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU6 = await upsertTrip('andaman-beach-scuba-jun-2026', {
      ...
      startDate: d(2026, 6, 4), endDate: d(2026, 6, 9), bookingDeadline: d(2026, 5, 25),
      pricePerPerson: 14499, earlyBirdPrice: 12499, earlyBirdDeadline: d(2026, 5, 10),
      ...
      cancellationPolicy: 'STRICT',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432074/seed/trips/trip-andaman-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432074/seed/trips/trip-andaman-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243456/seed/trips/tpmo4gbcmvoq0rswxbu2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243458/seed/trips/nftzjg8uvh4npjemgwtf.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
  })

  // ── Popular Destinations from Pune ───────────────────

  const tripU7 = await upsertTrip('goa-beach-escape-apr-2026', {
      organizerId: org1.id, destinationId: goa.id,
      title: 'Goa Beach Escape — 3N/4D from Pune',
      tripType: 'BEACH', bookingMode: 'INSTANT', seatSelectionEnabled: true,
      description: 'Experience Goa like never before — beyond the tourist crowds! Lush green landscapes, quiet beaches, dramatic waterfalls, and the freshest seafood of the year. Stay at a boutique resort in South Goa, explore the lesser-known Divar Island, kayak through mangroves, and enjoy Goan feni-tasting sessions. Perfect for those who want the real Goa.',
      itinerary: [
        ...
        { day: 2, title: 'Waterfalls & Spice Plantation', description: 'Nature & heritage experiences.', activities: [{ title: 'Dudhsagar Falls viewpoint trek', time: '7:00 AM' }, { title: 'Spice plantation lunch with feni tasting', time: '12:30 PM' }, { title: 'Old Goa churches (Basilica of Bom Jesus)', time: '3:30 PM' }, { title: 'Fontainhas Latin Quarter walk', time: '5:30 PM' }] },
      ...
      startDate: d(2026, 4, 17), endDate: d(2026, 4, 21), bookingDeadline: d(2026, 4, 12),
      pricePerPerson: 6999, earlyBirdPrice: 5999, earlyBirdDeadline: d(2026, 4, 1),
  ...
  const tripU8 = await upsertTrip('lonavala-trek-camping-apr-2026', {
      organizerId: org4.id, destinationId: lonavala.id,
      title: 'Lonavala Trek & Camping — 1N/2D from Pune',
      tripType: 'TREKKING', bookingMode: 'INSTANT',
      description: 'The quintessential Sahyadri trekking experience! Trek through scenic hills to Tikona Fort, explore Bhushi Dam, camp under the stars with a bonfire and Maharashtrian dinner. Just 2 hours from Pune — the perfect weekend escape into the Western Ghats.',
      itinerary: [
      ...
      startDate: d(2026, 4, 25), endDate: d(2026, 4, 27), bookingDeadline: d(2026, 4, 22),
      pricePerPerson: 2499,
      ...
      cancellationPolicy: 'FLEXIBLE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243459/seed/trips/rralp4rr0yildos26x1r.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243461/seed/trips/itvjuuvstiggqudwy28q.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU10 = await upsertTrip('ladakh-bike-expedition-may-2026', {
      organizerId: org2.id, destinationId: ladakh.id,
      title: 'Ladakh Bike Expedition — Manali to Leh 8N/9D',
      tripType: 'ROAD_TRIP', bookingMode: 'REQUEST_BASED',
      ...
      startDate: d(2026, 5, 10), endDate: d(2026, 5, 19), bookingDeadline: d(2026, 5, 1),
      pricePerPerson: 22999, earlyBirdPrice: 19999, earlyBirdDeadline: d(2026, 4, 20),
  ...
  const tripU11 = await upsertTrip('rishikesh-rafting-bungee-may-2026', {
      organizerId: org1.id, destinationId: rishikesh.id,
      ...
      startDate: d(2026, 5, 14), endDate: d(2026, 5, 16), bookingDeadline: d(2026, 5, 10),
      pricePerPerson: 4999,
  ...
  const tripU12 = await upsertTrip('jaipur-royal-heritage-food-trail-may-2026', {
      organizerId: org3.id, destinationId: jaipur.id,
      ...
      startDate: d(2026, 5, 21), endDate: d(2026, 5, 24), bookingDeadline: d(2026, 5, 16),
      pricePerPerson: 7499, earlyBirdPrice: 6499, earlyBirdDeadline: d(2026, 5, 5),
  ...
  console.log('  ✓ Created 12 completed trips (Jan-Jun 2026, ₹2.5K-23K range)')
...
async function seedBookingsAndReviews(deps: {
  ...
  const reviewData = [
    ...
    { tripId: ct.tripC1.id, bookingId: bC1_1.id, userId: t1.id, overall: 5, org: 5, val: 5, safe: 5, acc: 5, comment: 'Absolutely incredible trip! The beachfront resort was stunning, water sports were thrilling, and the group was amazing. Desi Wanderers really knows how to organize a perfect Goa getaway. Already planning my next trip with them!', daysAgo: 95 },
    ...
    // Manali Snow reviews
    { tripId: ct.tripC2.id, bookingId: bC2_1.id, userId: t3.id, overall: 5, org: 5, val: 5, safe: 5, acc: 5, comment: 'First time seeing snow and it exceeded every expectation! The cottage was cozy with amazing mountain views. Solang Valley skiing was the highlight. Peaks & Shore made this trip magical!', daysAgo: 80 },
    ...
    { tripId: ct.tripC4.id, bookingId: bC4_5.id, userId: t10.id, overall: 5, org: 5, val: 5, safe: 5, acc: 5, comment: 'The lassi at Lassiwala was the best thing I have ever tasted! The entire trip was a sensory overload — colors, flavors, history. Nomadic Trails curates experiences, not just trips. Big difference!', daysAgo: 45 },
  ...
  const reviewPhotos = [
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432068/seed/trips/review-goa-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243463/seed/trips/qcvqamcaozwzpm08xdk2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243464/seed/trips/qilhsjz0af0u2y7rydc2.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432068/seed/trips/review-goa-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243463/seed/trips/qcvqamcaozwzpm08xdk2.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432068/seed/trips/review-goa-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243464/seed/trips/qilhsjz0af0u2y7rydc2.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432068/seed/trips/review-goa-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243463/seed/trips/qcvqamcaozwzpm08xdk2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243464/seed/trips/qilhsjz0af0u2y7rydc2.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432068/seed/trips/review-goa-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243464/seed/trips/qilhsjz0af0u2y7rydc2.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432071/seed/trips/review-manali-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243467/seed/trips/n1d1fglhxzozkzmxpe2s.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243468/seed/trips/qlfpif5pdyvuyxpwkonh.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432071/seed/trips/review-manali-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243467/seed/trips/n1d1fglhxzozkzmxpe2s.jpg'],
    [],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432071/seed/trips/review-manali-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243467/seed/trips/n1d1fglhxzozkzmxpe2s.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243468/seed/trips/qlfpif5pdyvuyxpwkonh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243470/seed/trips/rxv6zx8amryqwdayughk.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432071/seed/trips/review-manali-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243467/seed/trips/n1d1fglhxzozkzmxpe2s.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432072/seed/trips/review-rishikesh-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243472/seed/trips/q9vrml5mhcay19hrvwri.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243473/seed/trips/nwaavtoy91ayuuotss6y.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432072/seed/trips/review-rishikesh-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243472/seed/trips/q9vrml5mhcay19hrvwri.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432072/seed/trips/review-rishikesh-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243472/seed/trips/q9vrml5mhcay19hrvwri.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243473/seed/trips/nwaavtoy91ayuuotss6y.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432072/seed/trips/review-rishikesh-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243472/seed/trips/q9vrml5mhcay19hrvwri.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432068/seed/trips/review-jaipur-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243477/seed/trips/awcjwvdmde1bgnkhdlre.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243478/seed/trips/w4raotvn42lli13bjxp1.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432071/seed/trips/review-jaipur-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243477/seed/trips/awcjwvdmde1bgnkhdlre.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432068/seed/trips/review-jaipur-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243478/seed/trips/w4raotvn42lli13bjxp1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243477/seed/trips/awcjwvdmde1bgnkhdlre.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432071/seed/trips/review-jaipur-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243477/seed/trips/awcjwvdmde1bgnkhdlre.jpg'],
    [],
  ]
  ...
  const orgReplies: Record<number, { reply: string; daysAfter: number }> = {
    ...
    4: { reply: 'Happy birthday to your friend! We love adding those personal touches. Thanks for choosing Desi Wanderers! 🎂', daysAfter: 3 },
    ...
    20: { reply: 'Sneha, your mother\'s reaction at Amber Fort made our team emotional too! That\'s exactly why we do this. Thank you for trusting Nomadic Trails with such a special trip! 🙏', daysAfter: 2 },
  }
...
const DEST_PHOTOS: Record<string, string[]> = {
  goa: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432037/seed/trips/bulk-goa-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432037/seed/trips/bulk-goa-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432059/seed/destinations/dest-goa.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243386/seed/destinations/zaklapq4u38dpchpwlf4.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243480/seed/trips/jby9xuggljkd5hxhrvjh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243481/seed/trips/gj7x61vxpyze9ro094dr.jpg'],
  manali: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432048/seed/trips/bulk-manali-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432048/seed/trips/bulk-manali-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432063/seed/destinations/dest-manali.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243387/seed/destinations/rwjp0z5obcvlygxpvhrb.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243483/seed/trips/jszmu5fgk9zifwcrmhdj.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243485/seed/trips/vx6zohtlcasibb4zjpzc.jpg'],
  ladakh: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432041/seed/trips/bulk-ladakh-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432046/seed/trips/bulk-ladakh-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432061/seed/destinations/dest-ladakh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243389/seed/destinations/qa4l3fntxmwryv94tk8w.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243487/seed/trips/llrd2yzonjddeebbv6n8.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243489/seed/trips/cq7r8njktp9g8gkcybcv.jpg'],
  rishikesh: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432051/seed/trips/bulk-rishikesh-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432053/seed/trips/bulk-rishikesh-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432065/seed/destinations/dest-rishikesh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243390/seed/destinations/knljydussngiqxlnqhbm.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243491/seed/trips/wj1tmcaa04v29uouu2ad.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243494/seed/trips/tyqoopvnyssev5hoodh3.jpg'],
  jaipur: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432039/seed/trips/bulk-jaipur-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432039/seed/trips/bulk-jaipur-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432062/seed/destinations/dest-jaipur.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243391/seed/destinations/td3seeqifvlrfoth3ztc.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243496/seed/trips/wjrezypq0inkqeg5unmh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243498/seed/trips/h0zmrujb2fagklqjlurj.jpg'],
  kasol: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432042/seed/trips/bulk-kasol-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432041/seed/trips/bulk-kasol-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432061/seed/destinations/dest-kasol.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243393/seed/destinations/t0cnzidrpimni3snzpxf.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243500/seed/trips/dratmfmnwddh3tnhgp2p.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243501/seed/trips/earnjrxxrqm4ojgen8dc.jpg'],
  lonavala: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432045/seed/trips/bulk-lonavala-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432046/seed/trips/bulk-lonavala-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432064/seed/destinations/dest-lonavala.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243400/seed/destinations/ncvt8ytjry03mrio6mzl.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243503/seed/trips/ud0yjvm7wkuaelty33xj.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243504/seed/trips/xzmn7iampl7xlzhcjcit.jpg'],
  udaipur: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432056/seed/trips/bulk-udaipur-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432056/seed/trips/bulk-udaipur-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432067/seed/destinations/dest-udaipur.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243395/seed/destinations/ojeqlpgiqh1x7z1mgeno.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243506/seed/trips/uwr1lodzrfcjd9l5khyo.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243508/seed/trips/nttgzbktac4u85c3xnlv.jpg'],
  meghalaya: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432048/seed/trips/bulk-meghalaya-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432049/seed/trips/bulk-meghalaya-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432063/seed/destinations/dest-meghalaya.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243396/seed/destinations/w2cctn6ra67ktvrdbytn.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243509/seed/trips/ia2diufdoxuqjkg8pwm5.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243511/seed/trips/eoanc77nhrprjfiaxhem.jpg'],
  hampi: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432037/seed/trips/bulk-hampi-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432039/seed/trips/bulk-hampi-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432059/seed/destinations/dest-hampi.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243398/seed/destinations/z1ybo7gdwjlzojtz3erl.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243513/seed/trips/lzmkv1favtmos3gyq3r6.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243515/seed/trips/gjzqnorwdyoldlsdneoj.jpg'],
  spiti: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432054/seed/trips/bulk-spiti-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432054/seed/trips/bulk-spiti-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432067/seed/destinations/dest-spiti.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243401/seed/destinations/ophe4q5e6pkp5mdmmcco.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243517/seed/trips/pfvx0bzrz1lhtoah0sqk.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243519/seed/trips/flnlqiqhiufwkuhbxx9a.jpg'],
  coorg: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432032/seed/trips/bulk-coorg-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432034/seed/trips/bulk-coorg-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432057/seed/destinations/dest-coorg.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243403/seed/destinations/ps0assfifuavmcskkmso.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243521/seed/trips/ziodxwdcf9mecjzv6mpb.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243523/seed/trips/z5io6lfuqvxsfw61l5em.jpg'],
  varanasi: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432056/seed/trips/bulk-varanasi-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432057/seed/trips/bulk-varanasi-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432067/seed/destinations/dest-varanasi.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243404/seed/destinations/yhhcjwury3eqx0f7vvqk.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243525/seed/trips/gzaecdtqpb5d5vk04jpp.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243526/seed/trips/lvch3anngp8tkripbxnw.jpg'],
  andaman: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432032/seed/trips/bulk-andaman-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432032/seed/trips/bulk-andaman-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432057/seed/destinations/dest-andaman.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243406/seed/destinations/r3ozpftp0egzgucys4aw.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243529/seed/trips/masfwhtw6mlzq3nuzqp3.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243531/seed/trips/xae6lmirbn08npntep0o.jpg'],
  dharamshala: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432034/seed/trips/bulk-dharamshala-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432034/seed/trips/bulk-dharamshala-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432059/seed/destinations/dest-dharamshala.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243408/seed/destinations/mez9hlgfarjg7votqfqt.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243533/seed/trips/mtjd4udygerpsitoslpa.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243535/seed/trips/lqspifskvxdjursbgfz9.jpg'],
  ooty: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432049/seed/trips/bulk-ooty-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432050/seed/trips/bulk-ooty-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432065/seed/destinations/dest-ooty.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243409/seed/destinations/zdz4apjsary22ky8txvq.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243537/seed/trips/oolonwrilqrfizqha8wm.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243539/seed/trips/jyahpyywuuedmebc7lyt.jpg'],
  rannOfKutch: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1785432051/seed/trips/bulk-rann-of-kutch-1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432051/seed/trips/bulk-rann-of-kutch-2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1785432066/seed/destinations/dest-rann-of-kutch.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243411/seed/destinations/mu6bevx5vfjdjlwkk8oy.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243540/seed/trips/kxgjcgg71dlnragcctzw.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243542/seed/trips/lrxdtf7ivczp7ldd6eng.jpg'],
}
...
async function seedBulkTrips(deps: Record<string, { id: string }>, travelers: { id: string }[]) {
  ...
  async function mk(o: BulkOpts) {
    ...
    const trip = await upsertTrip(o.slug, {
      ...
      acceptingBookings: false, inclusions: o.incl, exclusions: o.excl,
  ...
  // ── GOA (6) ────────────────────────────────────────────
  await mk({ dest: 'goa', orgIdx: 0, title: 'Goa New Year Beach Bash — 3N/4D Party Special from Pune', slug: 'goa-new-year-bash-dec-2025', type: 'BEACH', mode: 'INSTANT', desc: 'Ring in 2026 on golden sands of North Goa! Beach parties at Anjuna & Vagator, NYE countdown, water sports, Dudhsagar day trip, authentic seafood. AC Volvo from Pune.', days: 4, price: 8999, early: 7499, min: 12, max: 30, booked: 18, status: 'COMPLETED', cancel: 'STRICT', sM: 12, sD: 29, sY: 2025, incl: ['AC bus Pune-Goa-Pune', 'Resort (3N)', 'All meals', 'NYE party pass', 'Water sports'], excl: ['Alcohol', 'Personal expenses'], itin: ['Arrive & Beach Hopping — Calangute, Baga, Anjuna', 'Dudhsagar Falls & Spice Farm', 'Water Sports & NYE Party', 'Sunrise Swim & Departure'] })
  await mk({ dest: 'goa', orgIdx: 2, title: 'South Goa Wellness Retreat — 4N/5D Yoga & Nature', slug: 'south-goa-wellness-apr-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Pristine beaches, daily yoga at Agonda, Ayurvedic spa, mangrove kayaking, dolphins, silent walks at Cola and Butterfly beaches.', days: 5, price: 12499, early: 10999, min: 6, max: 14, booked: 8, status: 'COMPLETED', cancel: 'MODERATE', sM: 4, sD: 15, sY: 2026, incl: ['Eco-resort (4N)', 'Organic meals', 'Daily yoga', 'Spa session', 'Kayaking', 'Dolphin trip'], excl: ['Travel to Goa', 'Alcohol'], itin: ['Arrival & Sunset Yoga', 'Spa & Butterfly Beach', 'Kayaking & Dolphins', 'Cola Beach & Cooking Class', 'Meditation & Departure'] })
  ...
  await mk({ dest: 'goa', orgIdx: 1, title: 'Goa Scuba Diving & Snorkeling — 2N/3D Grande Island', slug: 'goa-scuba-diving-may-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'PADI-certified scuba at Grande Island! Snorkeling at coral reefs, island hopping, fresh catch BBQ. Perfect visibility season.', days: 3, price: 7999, early: 6999, min: 8, max: 16, booked: 5, status: 'COMPLETED', cancel: 'MODERATE', sM: 5, sD: 14, sY: 2026, incl: ['Scuba dive (PADI)', 'Snorkeling gear', 'Island boat', 'Resort (2N)', 'All meals'], excl: ['Travel to Goa', 'Underwater camera'], itin: ['Arrival & Pool Training', 'Grande Island Dive & Snorkel', 'North Goa & Departure'] })
  await mk({ dest: 'goa', orgIdx: 3, title: 'Goa Dudhsagar Waterfall Trek — 1N/2D from Pune', slug: 'goa-dudhsagar-trek-feb-2026', type: 'TREKKING', mode: 'INSTANT', desc: 'India\'s 5th tallest waterfall at its best! 11 km trek through Bhagwan Mahavir sanctuary, natural pools, spice plantation camping.', days: 2, price: 3499, min: 12, max: 25, booked: 25, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 2, sD: 15, sY: 2026, incl: ['Bus from Pune', 'Trek guide', 'Camp (1N)', 'All meals', 'Plantation visit'], excl: ['Rain gear', 'Snacks'], itin: ['11 km Jungle Trek to Dudhsagar Base, Campfire', 'Waterfall Viewpoint, Spice Plantation, Return'] })
  ...
  // ── MANALI (5) ─────────────────────────────────────────
  await mk({ dest: 'manali', orgIdx: 1, title: 'Manali Winter Wonderland — 4N/5D Snow Holiday from Delhi', slug: 'manali-winter-jan-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'Fresh snowfall, Solang skiing, igloo stay, Vashisht hot springs, Old Manali cafe hopping. AC Volvo from Delhi.', days: 5, price: 9999, early: 8499, min: 8, max: 20, booked: 6, status: 'COMPLETED', cancel: 'MODERATE', sM: 1, sD: 5, sY: 2026, incl: ['Delhi-Manali Volvo', 'Cottage (4N)', 'All meals', 'Skiing', 'Igloo', 'Bonfire'], excl: ['Paragliding', 'Shopping'], itin: ['Arrival & Old Manali Cafe Hop', 'Solang Valley Skiing & Snow Tubing', 'Atal Tunnel & Sissu Frozen Waterfalls', 'Igloo Stay & Vashisht Hot Springs', 'Mall Road & Departure'] })
  await mk({ dest: 'manali', orgIdx: 0, title: 'Hampta Pass Trek — 4N/5D Himalayan Crossing', slug: 'hampta-pass-trek-mar-2026', type: 'TREKKING', mode: 'REQUEST_BASED', desc: 'Cross from Kullu to Lahaul via Hampta Pass (4,270m). River crossings, alpine meadows, Chandratal Lake. Perfect moderate trek.', days: 5, price: 8499, early: 7499, min: 8, max: 15, booked: 10, status: 'COMPLETED', cancel: 'STRICT', sM: 3, sD: 12, sY: 2026, incl: ['Camping gear', 'All meals', 'Guide + cook', 'Manali transport', 'Permits'], excl: ['Travel to Manali', 'Personal gear'], itin: ['Manali to Chika via Jobra', 'Chika to Balu Ka Ghera', 'Hampta Pass Summit (4,270m)', 'Chandratal Lake & Stargazing', 'Return to Manali'] })
  ...
  await mk({ dest: 'manali', orgIdx: 1, title: 'Manali Paragliding & Rafting Combo — 2N/3D', slug: 'manali-paragliding-jan-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'Fly over Solang, conquer Beas rapids! Tandem paragliding, 14 km rafting, ATV rides, riverside camping.', days: 3, price: 6999, min: 10, max: 20, booked: 12, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 1, sD: 18, sY: 2026, incl: ['Paragliding', '14 km rafting', 'Camp (2N)', 'All meals', 'ATV', 'Bonfire'], excl: ['Travel to Manali', 'GoPro'], itin: ['Riverside Camp, ATV, Bonfire', 'Paragliding & Beas Rafting', 'Solang Zorbing & Departure'] })
  await mk({ dest: 'manali', orgIdx: 2, title: 'Manali Photography Expedition — 5N/6D Golden Hour', slug: 'manali-photography-apr-2026', type: 'CULTURAL', mode: 'REQUEST_BASED', desc: 'Capture the Himalayas with a pro! Golden hour shoots, Old Manali portraits, startrails, Lightroom workshops. Max 10 photographers.', days: 6, price: 15999, min: 6, max: 10, booked: 4, status: 'COMPLETED', cancel: 'STRICT', sM: 4, sD: 10, sY: 2026, incl: ['Cottage (5N)', 'All meals', 'Photo mentorship', 'Transport', 'Lightroom workshop'], excl: ['Camera gear', 'Travel to Manali'], itin: ['Beas River Golden Hour', 'Solang Sunrise Shoot', 'Old Manali Streets', 'Atal Tunnel Landscapes', 'Star Trail Night Shoot', 'Portfolio Review & Departure'] })
  console.log('  ✓ Bulk: Manali (5)')

  // ── LADAKH (4) ─────────────────────────────────────────
  await mk({ dest: 'ladakh', orgIdx: 1, title: 'Ladakh Frozen Chadar Trek — 7N/8D Winter Expedition', slug: 'ladakh-chadar-trek-jan-2026', type: 'TREKKING', mode: 'REQUEST_BASED', desc: 'Walk on frozen Zanskar River! Sub-zero camping, ice caves, frozen waterfalls. Experienced trekkers only. Medical cert required.', days: 8, price: 29999, early: 26999, min: 6, max: 10, booked: 4, status: 'COMPLETED', cancel: 'STRICT', sM: 1, sD: 15, sY: 2026, incl: ['Leh pickup', 'Camping gear', 'All meals', 'Guide + cook', 'Permits', 'Oxygen'], excl: ['Flights', 'Winter gear', 'Insurance'], itin: ['Arrive Leh — Acclimatize', 'Leh Palace & Stupa', 'Start Chadar Trek', 'Ice Caves Walk', 'Nerak Frozen Waterfall', 'Return Chadar', 'Drive to Leh', 'Departure'] })
  await mk({ dest: 'ladakh', orgIdx: 1, title: 'Ladakh SUV Road Trip — 5N/6D Nubra & Pangong', slug: 'ladakh-suv-trip-feb-2026', type: 'ROAD_TRIP', mode: 'INSTANT', desc: 'All of Ladakh by Innova! Nubra Valley dunes, Pangong camping, Khardung La, Hemis Monastery, Magnetic Hill. No bike needed.', days: 6, price: 18999, early: 16999, min: 6, max: 14, booked: 7, status: 'COMPLETED', cancel: 'MODERATE', sM: 2, sD: 10, sY: 2026, incl: ['Leh pickup/drop', 'Hotels + camps (5N)', 'All meals', 'Innova', 'Permits', 'Oxygen'], excl: ['Flights', 'AMS medicine'], itin: ['Arrive Leh — Rest', 'Leh Palace, Stupa, Hall of Fame', 'Nubra via Khardung La', 'Nubra to Pangong Lake', 'Pangong to Leh via Chang La', 'Magnetic Hill & Airport'] })
  await mk({ dest: 'ladakh', orgIdx: 1, title: 'Ladakh Mountain Biking — 6N/7D Pedal the Passes', slug: 'ladakh-mtb-mar-2026', type: 'ADVENTURE', mode: 'REQUEST_BASED', desc: 'Cycle the highest passes on premium MTBs! Khardung La, More Plains, Pangong route. Support vehicle included. Serious cyclists only.', days: 7, price: 24999, min: 4, max: 8, booked: 3, status: 'COMPLETED', cancel: 'STRICT', sM: 3, sD: 5, sY: 2026, incl: ['MTB rental', 'Support vehicle', 'All stays', 'All meals', 'Guide', 'Permits'], excl: ['Flights', 'Cycling gear'], itin: ['Arrive — Bike Fitting', 'South Pullu Warm-up', 'Khardung La Summit', 'Hemis Route', 'Chang La Approach', 'Pangong Camp', 'Return to Leh'] })
  await mk({ dest: 'ladakh', orgIdx: 2, title: 'Ladakh Family Tour — 4N/5D Kid-Friendly Sightseeing', slug: 'ladakh-family-jan-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'Ladakh with kids! Gentle acclimatization, short drives, Shanti Stupa, Hemis, Magnetic Hill. No extreme passes for safety.', days: 5, price: 14999, min: 8, max: 18, booked: 12, status: 'COMPLETED', cancel: 'MODERATE', sM: 1, sD: 10, sY: 2026, incl: ['Leh hotel (4N)', 'Kid meals', 'Innova', 'All entries', 'Medical kit'], excl: ['Flights'], itin: ['Arrive — Easy Day', 'Leh Palace & Stupa', 'Hemis & Thiksey', 'Magnetic Hill & Sangam', 'Shopping & Departure'] })
...
async function seedBulkPart2(deps: Record<string, { id: string }>, mk: (o: BulkOpts) => Promise<any>) {
  // ── RISHIKESH (5) ──────────────────────────────────────
  await mk({ dest: 'rishikesh', orgIdx: 0, title: 'Rishikesh Yoga Retreat — 4N/5D Ganges Immersion', slug: 'rishikesh-yoga-retreat-apr-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Deep yoga on the banks of the Ganges! Daily Ashtanga & Hatha, Pranayama workshops, silent meditation, Ayurvedic meals, evening Ganga Aarti. Certified instructors.', days: 5, price: 9999, early: 8499, min: 8, max: 16, booked: 10, status: 'COMPLETED', cancel: 'MODERATE', sM: 4, sD: 1, sY: 2026, incl: ['Ashram (4N)', 'Ayurvedic meals', 'Daily yoga', 'Meditation', 'Aarti', 'Certificate'], excl: ['Travel', 'Personal expenses'], itin: ['Arrival & Opening Circle', 'Ashtanga & Pranayama', 'Silent Forest Walk & Ganga Meditation', 'Advanced Practice & Philosophy', 'Closing Ceremony'] })
  await mk({ dest: 'rishikesh', orgIdx: 3, title: 'Rishikesh Bungee & Giant Swing Combo — 1N/2D', slug: 'rishikesh-bungee-swing-may-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'India\'s highest bungee (83m) AND giant swing in one weekend! Riverside camping, bonfire, morning yoga by the Ganges.', days: 2, price: 5999, min: 10, max: 20, booked: 16, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 5, sD: 8, sY: 2026, incl: ['Delhi bus', 'Bungee + Swing', 'Camp (1N)', 'All meals', 'Bonfire'], excl: ['Flying fox (optional)'], itin: ['Bungee 83m, Giant Swing, Camp', 'Yoga, Lakshman Jhula, Departure'] })
  await mk({ dest: 'rishikesh', orgIdx: 0, title: 'Rishikesh Kayaking School — 3N/4D Learn to Kayak on Ganges', slug: 'rishikesh-kayaking-school-apr-2026', type: 'ADVENTURE', mode: 'REQUEST_BASED', desc: 'Whitewater kayaking from pool to river! ACA-certified 4-day program on the Ganges with 10 km expedition finale.', days: 4, price: 11999, min: 4, max: 8, booked: 3, status: 'COMPLETED', cancel: 'STRICT', sM: 4, sD: 20, sY: 2026, incl: ['Kayak + gear', 'Instructor', 'Camp (3N)', 'All meals', 'ACA certificate'], excl: ['Travel', 'Waterproof bag'], itin: ['Pool Training & Theory', 'Flat Water Skills', 'Grade II Whitewater', '10 km Expedition & Certification'] })
  await mk({ dest: 'rishikesh', orgIdx: 3, title: 'Rishikesh New Year Camping & Rafting — 2N/3D', slug: 'rishikesh-new-year-camp-dec-2025', type: 'ADVENTURE', mode: 'INSTANT', desc: 'Ring in 2026 by the Ganges! NYE bonfire, 16 km rafting, cliff jumping, sunrise yoga. Live music and unlimited chai.', days: 3, price: 6499, early: 5499, min: 15, max: 30, booked: 22, status: 'COMPLETED', cancel: 'STRICT', sM: 12, sD: 30, sY: 2025, incl: ['Delhi bus', 'Camp (2N)', 'All meals', '16 km rafting', 'NYE party', 'Bonfire'], excl: ['Alcohol', 'Bungee'], itin: ['Arrival & Riverside Camp', 'Rafting & NYE Countdown', 'Sunrise Yoga & Departure'] })
  await mk({ dest: 'rishikesh', orgIdx: 0, title: 'Rishikesh Waterfall Trek — 1N/2D', slug: 'rishikesh-waterfall-trek-feb-2026', type: 'TREKKING', mode: 'INSTANT', desc: 'Hidden waterfalls in Rajaji forest, scenic streams, winter Ganges. Night camping with hot chai and pakoras.', days: 2, price: 2999, min: 12, max: 24, booked: 20, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 2, sD: 22, sY: 2026, incl: ['Delhi bus', 'Guide', 'Camp (1N)', 'All meals', 'Rain ponchos'], excl: ['Trekking shoes'], itin: ['Jungle Trail to Hidden Waterfalls, Camp', 'Ganges Viewpoint, Aarti, Departure'] })
  console.log('  ✓ Bulk: Rishikesh (5)')

  // ── JAIPUR (4) ─────────────────────────────────────────
  await mk({ dest: 'jaipur', orgIdx: 2, title: 'Jaipur Diwali Light Festival — 2N/3D Pink City Celebration', slug: 'jaipur-diwali-festival-nov-2025', type: 'CULTURAL', mode: 'INSTANT', desc: 'Diwali in the Pink City! Nahargarh Fort lit with 10,000 diyas, Amer Fort light show, traditional puja, sweets workshop, Johari Bazaar shopping.', days: 3, price: 8999, early: 7999, min: 8, max: 18, booked: 14, status: 'COMPLETED', cancel: 'MODERATE', sM: 11, sD: 1, sY: 2025, incl: ['Haveli (2N)', 'All meals', 'Diwali puja', 'Amer show', 'Sweet workshop', 'AC transport'], excl: ['Train/flight', 'Shopping budget'], itin: ['Arrival & Decorated Bazaars', 'Amer Fort, Sweets Workshop, Puja', 'Johari Bazaar & Departure'] })
  await mk({ dest: 'jaipur', orgIdx: 2, title: 'Jaipur Hot Air Balloon & Camel Safari — 2N/3D', slug: 'jaipur-balloon-safari-may-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'See the Pink City from the sky! Sunrise balloon over Amber Fort, camel safari, Rajasthani folk dinner, Nahargarh stargazing.', days: 3, price: 12999, early: 11499, min: 6, max: 12, booked: 5, status: 'COMPLETED', cancel: 'STRICT', sM: 5, sD: 14, sY: 2026, incl: ['Balloon ride', 'Camel safari', 'Heritage stay (2N)', 'All meals', 'Folk dinner'], excl: ['Flight/train'], itin: ['Hawa Mahal, City Palace, Nahargarh Sunset', 'Sunrise Balloon, Camel Ride, Folk Dinner', 'Amber Fort & Departure'] })
  await mk({ dest: 'jaipur', orgIdx: 3, title: 'Jaipur-Pushkar Camel Fair — 3N/4D Cultural Festival', slug: 'jaipur-pushkar-fair-nov-2025', type: 'CULTURAL', mode: 'INSTANT', desc: 'World-famous Pushkar Camel Fair! Thousands of camels, folk competitions, desert camping, Pushkar Lake holy dip, Brahma Temple.', days: 4, price: 9499, min: 10, max: 22, booked: 22, status: 'COMPLETED', cancel: 'MODERATE', sM: 11, sD: 6, sY: 2025, incl: ['Jaipur hotel (2N) + Pushkar camp (1N)', 'All meals', 'Fair entry', 'Desert camp', 'AC bus'], excl: ['Train/flight', 'Camel ride (₹300)'], itin: ['Jaipur — Amber Fort, Hawa Mahal', 'Pushkar — Camel Fair & Folk Shows', 'Pushkar Lake, Brahma Temple, Desert Camp', 'Return to Jaipur & Departure'] })
  await mk({ dest: 'jaipur', orgIdx: 0, title: 'Ranthambore Tiger Safari + Jaipur Heritage — 3N/4D', slug: 'ranthambore-tiger-jaipur-mar-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'Spot the Royal Bengal Tiger at Ranthambore! Two safari drives in open Canter, plus Jaipur forts and palaces. Jungle lodge + heritage haveli.', days: 4, price: 11999, early: 10499, min: 8, max: 16, booked: 10, status: 'COMPLETED', cancel: 'STRICT', sM: 3, sD: 18, sY: 2026, incl: ['Lodge (2N) + Haveli (1N)', 'All meals', '2 safaris', 'Park entry', 'Jaipur tour', 'AC transport'], excl: ['Train/flight'], itin: ['Jaipur — Amber Fort & Hawa Mahal', 'Drive to Ranthambore, Afternoon Safari', 'Double Safari — Sunrise & Sunset', 'Nature Walk, Drive to Jaipur, Departure'] })
  console.log('  ✓ Bulk: Jaipur (4)')

  // ── KASOL (4) ──────────────────────────────────────────
  await mk({ dest: 'kasol', orgIdx: 0, title: 'Sar Pass Trek — 4N/5D High Altitude Himalayan Crossing', slug: 'sar-pass-trek-jun-2026', type: 'TREKKING', mode: 'REQUEST_BASED', desc: 'Cross legendary Sar Pass (4,200m) through snow fields and pine forests! Snow slides, alpine camps, 360° Himalayan panoramas.', days: 5, price: 7999, early: 6999, min: 8, max: 15, booked: 9, status: 'COMPLETED', cancel: 'STRICT', sM: 6, sD: 8, sY: 2026, incl: ['Camping gear', 'All meals', 'Guide + cook', 'Transport', 'Permits'], excl: ['Travel to Kasol', 'Personal gear'], itin: ['Kasol to Grahan Village', 'Grahan to Min Thatch — Meadows', 'Min Thatch to Nagaru — Snow Fields', 'Sar Pass Summit (4,200m) & Snow Slide', 'Biskeri to Kasol'] })
  await mk({ dest: 'kasol', orgIdx: 3, title: 'Kasol Hippie Trail Weekend — 2N/3D Backpacker Special', slug: 'kasol-hippie-trail-mar-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'The ultimate Kasol chill weekend! Israeli cafes, Chalal village walk, Tosh camping, Manikaran hot springs, riverside bonfires.', days: 3, price: 3999, min: 10, max: 20, booked: 14, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 3, sD: 19, sY: 2026, incl: ['Delhi bus', 'Camp (2N)', 'All meals', 'Tosh trek', 'Manikaran', 'Bonfire'], excl: ['Cafe meals'], itin: ['Arrive & Chalal Village, Bonfire', 'Tosh Trek & Manikaran Hot Springs', 'Cafe Hopping & Departure'] })
  ...
  await mk({ dest: 'kasol', orgIdx: 3, title: 'Kasol Winter Snow Trek — 3N/4D Frozen Parvati Valley', slug: 'kasol-winter-snow-dec-2025', type: 'TREKKING', mode: 'INSTANT', desc: 'Kasol in winter! Snow-covered pines, frozen Parvati River, Tosh in white, hot chai at riverside camps. Easy winter trek for beginners.', days: 4, price: 5499, early: 4499, min: 8, max: 16, booked: 6, status: 'COMPLETED', cancel: 'MODERATE', sM: 12, sD: 20, sY: 2025, incl: ['Delhi bus', 'Camp (3N)', 'All meals', 'Snow guide', 'Bonfire', 'Tosh visit'], excl: ['Winter gear rental'], itin: ['Arrive & Riverside Snow Walk', 'Tosh Snow Trek & Hot Springs', 'Kheerganga Approach & Forest Camp', 'Morning Chai & Departure'] })
  console.log('  ✓ Bulk: Kasol (4)')

  // ── LONAVALA (5) ───────────────────────────────────────
  await mk({ dest: 'lonavala', orgIdx: 3, title: 'Lohagad Fort Sunrise Trek — Day Trip from Pune', slug: 'lohagad-sunrise-trek-apr-2026', type: 'TREKKING', mode: 'INSTANT', desc: 'Sunrise from 4,600 ft Lohagad Fort! Pre-dawn drive, Vinchukata (Scorpion Tail) ridge, twin fort exploration. Perfect Sunday morning.', days: 1, price: 999, min: 15, max: 30, booked: 25, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 4, sD: 12, sY: 2026, incl: ['Pune transport', 'Guide', 'Breakfast + chai', 'First aid'], excl: ['Lunch', 'Water bottle'], itin: ['4 AM Pickup, Sunrise Trek, Twin Forts, Return by Noon'] })
  await mk({ dest: 'lonavala', orgIdx: 3, title: 'Pawna Lake Camping — 1N/2D Weekend Escape from Pune', slug: 'pawna-lake-camping-mar-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Camp by Pawna Lake with Tung Fort backdrop! Sunset kayaking, BBQ dinner, lakeside bonfire, stargazing. Just 45 km from Pune.', days: 2, price: 1499, min: 12, max: 30, booked: 30, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 3, sD: 20, sY: 2026, incl: ['Tent + sleeping bag', 'BBQ dinner + breakfast', 'Bonfire', 'Kayaking'], excl: ['Transport to Pawna'], itin: ['Camp Setup, Kayaking, Sunset BBQ, Bonfire', 'Sunrise Chai, Breakfast, Pack Up'] })
  await mk({ dest: 'lonavala', orgIdx: 3, title: 'Rajmachi Firefly Festival Trek — 1N/2D Night Trek', slug: 'rajmachi-firefly-jun-2026', type: 'TREKKING', mode: 'INSTANT', desc: 'Millions of fireflies light up the Sahyadri! Night trek through bioluminescent forests, camping under firefly canopy, fort at dawn.', days: 2, price: 1999, min: 15, max: 30, booked: 30, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 6, sD: 5, sY: 2026, incl: ['Pune transport', 'Guide', 'Camp (1N)', 'Dinner + breakfast', 'Bonfire'], excl: ['Torch (red filter only)'], itin: ['Evening Drive, Night Trek, Firefly Show', 'Rajmachi Fort at Dawn, Descent, Pune'] })
  await mk({ dest: 'lonavala', orgIdx: 3, title: 'Lonavala 5-Fort Circuit Trek — 2N/3D Western Ghats', slug: 'lonavala-5-fort-circuit-may-2026', type: 'TREKKING', mode: 'INSTANT', desc: '5 Maratha forts in one epic trek! Lohagad, Visapur, Tikona, Tung, Korigad — connected by scenic Western Ghat ridgelines. Pawna Lake camping.', days: 3, price: 3499, min: 10, max: 18, booked: 8, status: 'COMPLETED', cancel: 'MODERATE', sM: 5, sD: 1, sY: 2026, incl: ['Pune transport', 'Guide', 'Camping (2N)', 'All meals', 'First aid'], excl: ['Trekking shoes'], itin: ['Lohagad & Visapur Twin Forts, Pawna Camp', 'Tikona & Tung Fort, Night Camp', 'Korigad Fort, Descent, Drive to Pune'] })
  await mk({ dest: 'lonavala', orgIdx: 3, title: 'Lonavala Waterfall Rappelling — Day Trip from Pune', slug: 'lonavala-rappelling-feb-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'Rappel down a 150 ft waterfall at Bekare! Certified instructors, pro safety gear. Most thrilling adventure near Pune.', days: 1, price: 1799, min: 10, max: 20, booked: 18, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 2, sD: 9, sY: 2026, incl: ['Pune pickup/drop', 'Rappelling gear', 'Instructor', 'Breakfast + lunch', 'Photos'], excl: ['Change of clothes'], itin: ['6 AM Pickup, Safety Brief, 150 ft Rappel, Lunch, Return 5 PM'] })
  console.log('  ✓ Bulk: Lonavala (5)')

  // ── UDAIPUR (3) ────────────────────────────────────────
  await mk({ dest: 'udaipur', orgIdx: 2, title: 'Udaipur Lake Experience — 2N/3D City of Lakes', slug: 'udaipur-lake-experience-feb-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'Udaipur is pure magic! Serene lakes, lush Aravalli hills, boat rides through mist, Kumbhalgarh Fort, Ranakpur Jain Temple.', days: 3, price: 8499, early: 7499, min: 6, max: 16, booked: 8, status: 'COMPLETED', cancel: 'MODERATE', sM: 2, sD: 20, sY: 2026, incl: ['Lakeside hotel (2N)', 'All meals', 'Boat ride', 'Kumbhalgarh', 'Ranakpur', 'AC transport'], excl: ['Train/flight', 'Shopping'], itin: ['City Palace, Lake Pichola Boat, Folk Dinner', 'Kumbhalgarh & Ranakpur Temples', 'Fateh Sagar Walk & Departure'] })
  await mk({ dest: 'udaipur', orgIdx: 2, title: 'Udaipur-Mount Abu Hill Station Combo — 3N/4D', slug: 'udaipur-mount-abu-apr-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Two Rajasthan gems! Udaipur lakeside romance + Mount Abu hill station cool. Dilwara Temples, Nakki Lake, Guru Shikhar sunset.', days: 4, price: 10999, early: 9499, min: 8, max: 18, booked: 11, status: 'COMPLETED', cancel: 'MODERATE', sM: 4, sD: 5, sY: 2026, incl: ['Hotel (3N)', 'All meals', 'Entries', 'AC transport', 'Boat rides'], excl: ['Train/flight'], itin: ['Udaipur City Palace & Pichola Boat', 'Mount Abu — Dilwara, Nakki, Sunset Point', 'Guru Shikhar & Return to Udaipur', 'Hathi Pol Markets & Departure'] })
...
async function seedBulkPart3(_deps: Record<string, { id: string }>, mk: (o: BulkOpts) => Promise<any>) {
  // ── MEGHALAYA (3) ──────────────────────────────────────
  await mk({ dest: 'meghalaya', orgIdx: 1, title: 'Meghalaya Living Root Bridge Trek — 4N/5D Northeast Discovery', slug: 'meghalaya-root-bridge-apr-2026', type: 'TREKKING', mode: 'REQUEST_BASED', desc: 'Double-decker living root bridges, crystal Dawki river, Asia\'s cleanest village Mawlynnong, limestone caves, and Cherrapunji waterfalls. Beyond the usual tourist trail.', days: 5, price: 13999, early: 11999, min: 6, max: 14, booked: 6, status: 'COMPLETED', cancel: 'STRICT', sM: 4, sD: 15, sY: 2026, incl: ['Shillong pickup', 'All stays (4N)', 'All meals', 'Dawki boating', 'Transport', 'Guide'], excl: ['Flights', 'Porter'], itin: ['Arrive Shillong — Don Bosco Museum', 'Cherrapunji Waterfalls & Mawsmai Cave', 'Root Bridge Trek — 3,500 Steps, Rainbow Falls', 'Dawki Crystal River & Mawlynnong Village', 'Laitlum Canyon Trek & Departure'] })
  await mk({ dest: 'meghalaya', orgIdx: 1, title: 'Meghalaya Caving Expedition — 3N/4D Underground Adventure', slug: 'meghalaya-caving-may-2026', type: 'ADVENTURE', mode: 'REQUEST_BASED', desc: 'Explore India\'s longest caves in Jaintia Hills! Krem Mawmluh, Krem Liat Prah (India\'s longest), underground river passages. For adventure seekers.', days: 4, price: 10999, min: 6, max: 10, booked: 4, status: 'COMPLETED', cancel: 'STRICT', sM: 5, sD: 5, sY: 2026, incl: ['All stays', 'All meals', 'Caving gear', 'Expert guide', 'Transport'], excl: ['Flights', 'Personal headlamp'], itin: ['Shillong — Caving Theory & Gear Fitting', 'Krem Mawmluh Cave Exploration', 'Krem Liat Prah — Underground River', 'Nohkalikai Falls & Departure'] })
  await mk({ dest: 'meghalaya', orgIdx: 1, title: 'Meghalaya Photography Expedition — 4N/5D Wettest Place on Earth', slug: 'meghalaya-photo-expedition-feb-2026', type: 'CULTURAL', mode: 'REQUEST_BASED', desc: 'Photograph the wettest place on Earth! Cascading waterfalls, root bridges in mist, crystal rivers, dramatic cloudscapes.', days: 5, price: 14999, min: 6, max: 8, booked: 6, status: 'COMPLETED', cancel: 'STRICT', sM: 2, sD: 10, sY: 2026, incl: ['All stays', 'All meals', 'Photo mentor', 'Transport', 'Rain gear'], excl: ['Flights', 'Camera gear'], itin: ['Shillong Cloudscapes', 'Cherrapunji Waterfalls', 'Root Bridges in Mist', 'Dawki Crystal River Photography', 'Portfolio Review & Departure'] })
  console.log('  ✓ Bulk: Meghalaya (3)')

  // ── HAMPI (3) ──────────────────────────────────────────
  await mk({ dest: 'hampi', orgIdx: 2, title: 'Hampi Heritage & Bouldering — 2N/3D Ruins & Rock Climbing', slug: 'hampi-heritage-bouldering-may-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'UNESCO ruins by day, world-class bouldering by afternoon! Vijayanagara temples, Hippie Island cafes, coracle rides, Matanga Hill sunset.', days: 3, price: 5999, min: 8, max: 16, booked: 10, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 5, sD: 20, sY: 2026, incl: ['Guesthouse (2N)', 'All meals', 'Bouldering guide + gear', 'Coracle ride', 'Monument tickets'], excl: ['Train to Hospet'], itin: ['Virupaksha Temple, Hampi Bazaar, Elephant Stables', 'Bouldering, Hippie Island Cafes, Matanga Sunset', 'Anegundi Monkey Temple, Coracle Ride, Departure'] })
  await mk({ dest: 'hampi', orgIdx: 2, title: 'Hampi Cycle Tour — 2N/3D Ruins on Wheels', slug: 'hampi-cycle-tour-jun-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'Explore 500-year-old Vijayanagara Empire ruins on bicycles! Cover 25+ monuments across the boulder-strewn landscape. Photography heaven.', days: 3, price: 4999, min: 8, max: 16, booked: 9, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 6, sD: 12, sY: 2026, incl: ['Guesthouse (2N)', 'All meals', 'Bicycle rental', 'Guide', 'Monument tickets'], excl: ['Train to Hospet'], itin: ['Royal Enclosure & Underground Temple by Cycle', 'Vittala Temple, Stone Chariot, Musical Pillars', 'Hippie Island, Sanapur Lake & Departure'] })
  await mk({ dest: 'hampi', orgIdx: 2, title: 'Hampi Backpacker Budget Trip — 2N/3D', slug: 'hampi-backpacker-jan-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'Hampi on a shoestring! Dorm stay on Hippie Island, self-guided ruin walks, Tungabhadra coracle ride, sunset at Hemakuta Hill. The backpacker\'s dream.', days: 3, price: 2999, min: 10, max: 20, booked: 14, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 1, sD: 10, sY: 2026, incl: ['Dorm stay (2N)', 'Breakfast + dinner', 'Coracle ride', 'Map + self-guide booklet'], excl: ['Train to Hospet', 'Lunch', 'Monument tickets (₹40)'], itin: ['Arrive Hippie Island, Hemakuta Sunset', 'Temple Circuit & Coracle Ride', 'Sanapur Lake, Bazaar Walk, Departure'] })
  console.log('  ✓ Bulk: Hampi (3)')

  // ── SPITI (3) ──────────────────────────────────────────
  await mk({ dest: 'spiti', orgIdx: 0, title: 'Spiti Valley Circuit — 7N/8D Complete Expedition', slug: 'spiti-valley-circuit-feb-2026', type: 'ROAD_TRIP', mode: 'REQUEST_BASED', desc: 'Complete Spiti circuit — Manali to Shimla! Key Monastery, Chandratal Lake, Dhankar, Pin Valley, world\'s highest post office Hikkim. Moonscape landscapes and ancient Buddhist culture.', days: 8, price: 19999, early: 17999, min: 6, max: 12, booked: 5, status: 'COMPLETED', cancel: 'STRICT', sM: 2, sD: 1, sY: 2026, incl: ['Homestays + camps (7N)', 'All meals', 'Tempo Traveller', 'Permits', 'Guide'], excl: ['Travel to Manali', 'Personal gear'], itin: ['Manali to Jispa', 'Jispa to Chandratal Lake', 'Chandratal to Kaza via Kunzum La', 'Key Monastery, Kibber & Hikkim', 'Pin Valley & Dhankar Fort', 'Tabo Monastery & Nako Lake', 'Nako to Kalpa — Kinnaur Valley', 'Shimla Departure'] })
  await mk({ dest: 'spiti', orgIdx: 0, title: 'Spiti Winter Snow Leopard Trail — 6N/7D', slug: 'spiti-snow-leopard-feb-2026', type: 'ADVENTURE', mode: 'REQUEST_BASED', desc: 'Track the elusive snow leopard in frozen Spiti! Winter homestays in Kibber, wildlife spotting with expert naturalists, frozen landscape photography. Limited to 8 travelers.', days: 7, price: 32999, min: 4, max: 8, booked: 3, status: 'COMPLETED', cancel: 'STRICT', sM: 2, sD: 5, sY: 2026, incl: ['Kaza homestays (6N)', 'All meals', 'Naturalist guide', 'Spotting scope', '4x4 transport', 'Permits'], excl: ['Flights to Kaza', 'Winter gear', 'Insurance'], itin: ['Arrive Kaza — Acclimatize', 'Kibber Wildlife Sanctuary', 'Snow Leopard Spotting — Chicham', 'Kibber to Langza — Fossil Hunting', 'Key Monastery in Snow', 'Dhankar Fort & Pin Valley', 'Departure'] })
  await mk({ dest: 'spiti', orgIdx: 0, title: 'Chandratal Lake Trek — 3N/4D Moonlit Camping', slug: 'chandratal-trek-jan-2026', type: 'TREKKING', mode: 'INSTANT', desc: 'Trek to the legendary Moon Lake at 4,300m! Alpine meadows, wildflower trails, and camping by the crystal-clear crescent-shaped lake under a billion stars.', days: 4, price: 6999, min: 8, max: 15, booked: 12, status: 'COMPLETED', cancel: 'MODERATE', sM: 1, sD: 5, sY: 2026, incl: ['Camp (3N)', 'All meals', 'Guide + cook', 'Manali transport', 'Permits'], excl: ['Travel to Manali', 'Personal gear'], itin: ['Manali to Batal via Rohtang', 'Batal to Chandratal Lake Trek', 'Lake Day — Photography & Meditation', 'Return to Manali'] })
  console.log('  ✓ Bulk: Spiti (3)')

  // ── COORG (3) ──────────────────────────────────────────
  await mk({ dest: 'coorg', orgIdx: 2, title: 'Coorg Coffee Plantation Retreat — 2N/3D from Bangalore', slug: 'coorg-coffee-retreat-apr-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Misty hills, coffee estate stay, plantation walk, Dubare elephant camp, Abbey Falls, Madikeri fort, and authentic Kodava cuisine. Perfect weekend escape from Bangalore.', days: 3, price: 6999, early: 5999, min: 8, max: 18, booked: 12, status: 'COMPLETED', cancel: 'MODERATE', sM: 4, sD: 10, sY: 2026, incl: ['Bangalore bus', 'Estate stay (2N)', 'All meals', 'Plantation walk', 'Elephant camp', 'Abbey Falls'], excl: ['Personal expenses'], itin: ['Arrive & Coffee Plantation Walk', 'Dubare Elephant Camp & Abbey Falls', 'Madikeri Fort, Market, Departure'] })
  await mk({ dest: 'coorg', orgIdx: 2, title: 'Coorg Trekking & Camping Weekend — 1N/2D Tadiandamol', slug: 'coorg-tadiandamol-trek-may-2026', type: 'TREKKING', mode: 'INSTANT', desc: 'Summit Tadiandamol (1,748m), the highest peak of Coorg! Grassland trails through shola forests, panoramic views of the Western Ghats, and camping under the stars.', days: 2, price: 3499, min: 10, max: 20, booked: 15, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 5, sD: 15, sY: 2026, incl: ['Bangalore bus', 'Camp (1N)', 'All meals', 'Trek guide', 'Bonfire'], excl: ['Trekking shoes', 'Personal gear'], itin: ['Drive to Base, Trek to Summit, Camp', 'Sunrise at Peak, Descent, Return Bangalore'] })
  await mk({ dest: 'coorg', orgIdx: 2, title: 'Coorg Waterfalls & Rafting — 2N/3D', slug: 'coorg-waterfalls-rafting-feb-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'Coorg at its greenest — lush hills, roaring waterfalls, Barapole river rafting (Grade III), coffee estate walks, and misty Mandalpatti viewpoint.', days: 3, price: 5999, min: 10, max: 18, booked: 16, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 2, sD: 14, sY: 2026, incl: ['Bangalore bus', 'Homestay (2N)', 'All meals', 'Rafting', 'Waterfall trek', 'Plantation walk'], excl: ['Personal expenses'], itin: ['Arrive, Mallalli Falls Trek', 'Barapole Rafting & Coffee Plantation', 'Mandalpatti Jeep Ride & Departure'] })
  console.log('  ✓ Bulk: Coorg (3)')

  // ── VARANASI (3) ───────────────────────────────────────
  await mk({ dest: 'varanasi', orgIdx: 3, title: 'Varanasi Spiritual Immersion — 2N/3D Ganga Aarti & Temples', slug: 'varanasi-spiritual-ganga-may-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'The spiritual heart of India! Sunrise boat ride on the Ganges, Ganga Aarti at Dashashwamedh Ghat, Kashi Vishwanath Temple, Sarnath Buddhist pilgrimage, and narrow lane food walks.', days: 3, price: 5999, early: 4999, min: 8, max: 20, booked: 14, status: 'COMPLETED', cancel: 'MODERATE', sM: 5, sD: 20, sY: 2026, incl: ['Heritage hotel (2N)', 'All meals', 'Boat ride', 'Temple visits', 'Sarnath trip', 'Guide'], excl: ['Train/flight', 'Personal puja items'], itin: ['Arrive, Evening Ganga Aarti — Dashashwamedh', 'Sunrise Boat Ride, Temples, Food Walk', 'Sarnath Buddhist Site & Departure'] })
  await mk({ dest: 'varanasi', orgIdx: 3, title: 'Varanasi Dev Deepawali Festival — 2N/3D', slug: 'varanasi-dev-deepawali-nov-2025', type: 'CULTURAL', mode: 'INSTANT', desc: 'Witness a million diyas on the Ganges ghats during Dev Deepawali! The most spectacular festival in Varanasi — boat ride through lit ghats, special aarti, laser show.', days: 3, price: 7999, min: 10, max: 22, booked: 22, status: 'COMPLETED', cancel: 'STRICT', sM: 11, sD: 15, sY: 2025, incl: ['Heritage hotel (2N)', 'All meals', 'Festival boat ride', 'Special aarti', 'Guide', 'Sarnath visit'], excl: ['Train/flight', 'Shopping'], itin: ['Arrive, Explore Ghats & Lanes', 'Dev Deepawali — Million Diyas Festival', 'Sarnath & Departure'] })
  await mk({ dest: 'varanasi', orgIdx: 3, title: 'Varanasi Food & Culture Trail — 2N/3D Culinary Journey', slug: 'varanasi-food-trail-apr-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'Explore Varanasi through its legendary food! Kachori Gali breakfast, blue lassi, tamatar chaat, boat ride, silk weaving workshop, and evening aarti. A feast for all senses.', days: 3, price: 5499, min: 8, max: 16, booked: 10, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 4, sD: 8, sY: 2026, incl: ['Hotel (2N)', 'All food trail meals', 'Boat ride', 'Silk workshop', 'Guide'], excl: ['Train/flight'], itin: ['Arrive, Evening Food Walk & Aarti', 'Sunrise Boat, Temple Trail, Silk Weaving', 'Kachori Gali Breakfast & Departure'] })
  console.log('  ✓ Bulk: Varanasi (3)')

  // ── ANDAMAN (3) ────────────────────────────────────────
  await mk({ dest: 'andaman', orgIdx: 1, title: 'Andaman Island Hopping — 5N/6D Beach & Snorkel Paradise', slug: 'andaman-island-hopping-may-2026', type: 'BEACH', mode: 'INSTANT', desc: 'Crystal clear waters, pristine beaches, and vibrant coral reefs! Havelock Island snorkeling at Elephant Beach, Neil Island cycling, Radhanagar Beach sunset, and Cellular Jail sound & light show.', days: 6, price: 22999, early: 19999, min: 6, max: 14, booked: 7, status: 'COMPLETED', cancel: 'MODERATE', sM: 5, sD: 10, sY: 2026, incl: ['Port Blair airport pickup', 'Resort (5N)', 'All meals', 'Ferry tickets', 'Snorkeling', 'Cellular Jail', 'All transport'], excl: ['Flights', 'Scuba (optional)', 'Water camera'], itin: ['Arrive Port Blair, Cellular Jail Light Show', 'Havelock — Radhanagar Beach Sunset', 'Elephant Beach Snorkeling & Kayaking', 'Neil Island — Cycling & Natural Bridge', 'Glass-Bottom Boat, Coral Gardens', 'Ross Island & Departure'] })
  await mk({ dest: 'andaman', orgIdx: 1, title: 'Andaman Scuba Diving Course — 4N/5D PADI Open Water', slug: 'andaman-scuba-course-jun-2026', type: 'ADVENTURE', mode: 'REQUEST_BASED', desc: 'Get PADI Open Water certified in tropical Andaman! Theory + pool + 4 open water dives at Havelock. See manta rays, sea turtles, coral gardens. Lifetime certification.', days: 5, price: 26999, min: 4, max: 8, booked: 3, status: 'COMPLETED', cancel: 'STRICT', sM: 6, sD: 5, sY: 2026, incl: ['Havelock resort (4N)', 'All meals', 'PADI course + certification', '4 open water dives', 'All equipment', 'Ferry'], excl: ['Flights', 'Underwater camera'], itin: ['Arrive, Theory & Pool Session', 'Confined Water Dives', 'Open Water Dive 1 & 2', 'Open Water Dive 3 & 4 — Certification!', 'Radhanagar Beach & Departure'] })
  await mk({ dest: 'andaman', orgIdx: 1, title: 'Andaman Honeymoon Special — 4N/5D Romance on the Islands', slug: 'andaman-honeymoon-feb-2026', type: 'BEACH', mode: 'INSTANT', desc: 'The ultimate island honeymoon! Private beach dinners, couple spa at Havelock, sunset cruise, candlelit Radhanagar Beach, glass-bottom boat ride. Pure paradise.', days: 5, price: 29999, early: 26999, min: 2, max: 10, booked: 4, status: 'COMPLETED', cancel: 'MODERATE', sM: 2, sD: 14, sY: 2026, incl: ['Beach resort (4N)', 'All meals', 'Private dinner', 'Couple spa', 'Sunset cruise', 'Ferry', 'All transport'], excl: ['Flights', 'Alcohol'], itin: ['Arrive, Cellular Jail, Candlelit Dinner', 'Havelock — Radhanagar Sunset, Spa', 'Elephant Beach Snorkeling, Private Dinner', 'Neil Island Day Trip', 'Sunrise Swim & Departure'] })
  console.log('  ✓ Bulk: Andaman (3)')

  // ── DHARAMSHALA (3) ─────────────────────────────────────
  await mk({ dest: 'dharamshala', orgIdx: 2, title: 'Dharamshala Triund Trek & McLeod Ganj — 2N/3D Himalayan Weekend from Delhi', slug: 'dharamshala-triund-trek-apr-2026', type: 'TREKKING', mode: 'INSTANT', desc: 'One of India\'s most scenic weekend treks! Triund summit (2,828m) with 360-degree Dhauladhar views, McLeod Ganj Tibetan culture walk, Bhagsunag waterfall, and authentic Tibetan momos. Perfect beginner-friendly Himalayan trek from Delhi.', days: 3, price: 4999, early: 3999, min: 8, max: 20, booked: 12, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 4, sD: 18, sY: 2026, incl: ['Guesthouse (2N)', 'All meals', 'Trek guide', 'Camping gear', 'McLeod Ganj walk', 'Bhagsunag visit'], excl: ['Bus/flight to Dharamshala', 'Personal trekking shoes'], itin: ['Arrive McLeod Ganj, Tibetan Market & Momos', 'Triund Trek — Summit & Camping', 'Bhagsunag Waterfall & Departure'] })
  await mk({ dest: 'dharamshala', orgIdx: 2, title: 'Dharamshala Yoga & Meditation Retreat — 4N/5D Spiritual Escape', slug: 'dharamshala-yoga-retreat-may-2026', type: 'CULTURAL', mode: 'REQUEST_BASED', desc: 'Find your inner peace in the land of the Dalai Lama. Daily yoga sessions with Himalayan views, guided meditation at Tushita Meditation Centre, Tibetan monastery visits, and nature walks through rhododendron forests. All levels welcome.', days: 5, price: 8999, min: 6, max: 14, booked: 5, status: 'COMPLETED', cancel: 'MODERATE', sM: 5, sD: 8, sY: 2026, incl: ['Yoga retreat stay (4N)', 'Vegetarian meals', 'Daily yoga + meditation', 'Monastery visits', 'Nature walks', 'Triund day trek'], excl: ['Transport to Dharamshala', 'Yoga mat (or rent ₹100)'], itin: ['Arrive, Evening Meditation Introduction', 'Sunrise Yoga, Dalai Lama Temple, Tushita Centre', 'Full Day: Yoga, Tibetan Cooking Class, Forest Walk', 'Triund Day Trek with Sunset Meditation', 'Final Session & Departure'] })
  await mk({ dest: 'dharamshala', orgIdx: 2, title: 'Dharamshala Budget Backpacking Trip — 2N/3D McLeod Ganj Explorer', slug: 'dharamshala-backpacking-mar-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'Budget-friendly backpacking through Dharamshala and McLeod Ganj! Hostel stays, street food trail, Bhagsunag waterfall swim, Naddi sunset point, and Tibetan handicraft shopping. The perfect weekend escape for young travelers.', days: 3, price: 2999, min: 10, max: 24, booked: 18, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 3, sD: 12, sY: 2026, incl: ['Hostel (2N)', 'Breakfast', 'Local guide', 'Bhagsunag trek', 'Market walk'], excl: ['Bus to Dharamshala', 'Lunch & dinner'], itin: ['Arrive, McLeod Ganj Walking Tour', 'Bhagsunag Waterfall, Naddi Sunset', 'Tibetan Market, Departure'] })
  console.log('  ✓ Bulk: Dharamshala (3)')

  // ── OOTY (3) ────────────────────────────────────────────
  await mk({ dest: 'ooty', orgIdx: 1, title: 'Ooty & Coonoor Hill Station Retreat — 3N/4D Tea Trails from Bangalore', slug: 'ooty-coonoor-retreat-apr-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Escape to the Nilgiri Hills! Ride the UNESCO toy train from Mettupalayam to Ooty, walk through tea plantations in Coonoor, visit the Botanical Garden, and catch sunrise at Doddabetta Peak. The perfect South Indian hill station getaway from Bangalore.', days: 4, price: 6999, early: 5999, min: 8, max: 18, booked: 10, status: 'COMPLETED', cancel: 'MODERATE', sM: 4, sD: 24, sY: 2026, incl: ['Resort (3N)', 'All meals', 'Toy train ticket', 'Tea plantation visit', 'Doddabetta entry', 'All transport from Mysore'], excl: ['Bus/flight to Mysore', 'Shopping'], itin: ['Arrive Mysore, Drive to Ooty, Botanical Garden', 'Toy Train to Coonoor, Tea Plantation Walk', 'Doddabetta Peak Sunrise, Pykara Falls', 'Ooty Lake, Departure via Bandipur Forest'] })
  await mk({ dest: 'ooty', orgIdx: 1, title: 'Ooty Mist & Tea Trail — 2N/3D Nilgiri Waterfalls from Bangalore', slug: 'ooty-mist-tea-trail-feb-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Experience Ooty in its greenest avatar! Misty valleys, cascading waterfalls at Pykara, tea estate walks in the rain, and warm soup at colonial-era bakeries. Magical fog-draped Nilgiri landscapes you will never forget.', days: 3, price: 4999, min: 8, max: 20, booked: 16, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 2, sD: 15, sY: 2026, incl: ['Hotel (2N)', 'All meals', 'Pykara falls', 'Tea plantation', 'Ooty Lake boating', 'Transport'], excl: ['Bus to Ooty', 'Rain gear (recommended)'], itin: ['Arrive, Rose Garden, Ooty Lake Boating', 'Pykara Falls Trek, Tea Estate Walk', 'Doddabetta, Coonoor & Departure'] })
  await mk({ dest: 'ooty', orgIdx: 1, title: 'Ooty Wildlife & Nature Trail — 3N/4D Mudumalai Safari from Bangalore', slug: 'ooty-wildlife-safari-jun-2026', type: 'ADVENTURE', mode: 'REQUEST_BASED', desc: 'Combine Nilgiri hill station charm with Mudumalai Tiger Reserve safari! Spot elephants, bison, and deer on jeep safaris. Visit Ooty tea gardens, Pykara waterfalls, and the scenic Ooty-Coonoor toy train route.', days: 4, price: 8499, min: 6, max: 14, booked: 4, status: 'COMPLETED', cancel: 'MODERATE', sM: 6, sD: 20, sY: 2026, incl: ['Resort (3N)', 'All meals', 'Mudumalai jeep safari', 'Toy train ticket', 'Pykara falls', 'Naturalist guide'], excl: ['Bus/flight to Mysore', 'Camera fees at safari'], itin: ['Arrive, Drive through Bandipur, Mudumalai Check-in', 'Morning & Evening Safari, Waterhole Visit', 'Ooty — Tea Gardens, Toy Train, Doddabetta', 'Pykara Falls & Departure'] })
  console.log('  ✓ Bulk: Ooty (3)')

  // ── RANN OF KUTCH (3) ──────────────────────────────────
  await mk({ dest: 'rannOfKutch', orgIdx: 3, title: 'Rann of Kutch Full Moon Festival — 3N/4D White Desert Experience from Ahmedabad', slug: 'rann-utsav-fullmoon-jan-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'Walk on the infinite white salt desert under a full moon! Rann Utsav tent city stay, Kutchi folk dance, handicraft village visits, Dholavira archaeological site, and the stunning Kala Dungar sunset — India\'s most unique landscape experience.', days: 4, price: 9999, early: 8499, min: 8, max: 22, booked: 15, status: 'COMPLETED', cancel: 'MODERATE', sM: 1, sD: 12, sY: 2026, incl: ['Tent city stay (3N)', 'All meals', 'Rann full moon walk', 'Kutchi village tour', 'Dholavira visit', 'Folk performances', 'Transport from Bhuj'], excl: ['Flight to Bhuj/Ahmedabad', 'Camel ride (₹200 extra)'], itin: ['Arrive Bhuj, Drive to Tent City, Evening Folk Show', 'White Rann Walk, Kutchi Village Handicrafts', 'Dholavira Archaeological Site, Kala Dungar Sunset', 'Full Moon Night Walk & Departure'] })
  await mk({ dest: 'rannOfKutch', orgIdx: 3, title: 'Rann of Kutch Photography Expedition — 3N/4D Desert Landscapes', slug: 'rann-photography-expedition-jun-2026', type: 'CULTURAL', mode: 'REQUEST_BASED', desc: 'A photographer\'s dream — capture the surreal white desert at golden hour, Kutchi women in embroidered attire, flamingo colonies at Little Rann, Dholavira ruins at sunrise, and star trails over the infinite salt flat. Led by a professional landscape photographer.', days: 4, price: 12999, min: 6, max: 12, booked: 4, status: 'COMPLETED', cancel: 'STRICT', sM: 6, sD: 18, sY: 2026, incl: ['Desert camp (3N)', 'All meals', 'Photography mentor', 'Little Rann flamingo safari', 'Golden hour sessions', 'Transport'], excl: ['Camera equipment', 'Flight to Bhuj'], itin: ['Arrive, Golden Hour White Rann Shoot', 'Flamingo Colony, Kutchi Village Portraits', 'Dholavira Ruins Sunrise, Star Trail Night Session', 'Final Edits Workshop & Departure'] })
  await mk({ dest: 'rannOfKutch', orgIdx: 3, title: 'Rann of Kutch Budget Trip — 2N/3D White Desert & Kutch Culture', slug: 'rann-budget-trip-feb-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'Experience the surreal White Rann on a budget! Stay in Bhuj, visit the salt desert, explore Kutchi craft villages, see the Aina Mahal mirror palace, and drive to Kala Dungar border viewpoint. Best budget way to see Kutch.', days: 3, price: 4999, min: 10, max: 24, booked: 20, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 2, sD: 8, sY: 2026, incl: ['Bhuj hotel (2N)', 'All meals', 'White Rann visit', 'Village tour', 'Kala Dungar', 'Transport'], excl: ['Flight to Bhuj', 'Camel ride'], itin: ['Arrive Bhuj, Aina Mahal, Prag Mahal', 'White Rann, Kutch Craft Villages, Sunset', 'Kala Dungar Border View & Departure'] })
  console.log('  ✓ Bulk: Rann of Kutch (3)')

  // ── WOMEN-ONLY TRIPS by She Travels India (orgIdx 4) ───
  await mk({ dest: 'goa', orgIdx: 4, title: 'Women-Only Goa Beach Retreat — 3N/4D All-Girls Getaway from Pune', slug: 'women-only-goa-retreat-jan-2026', type: 'BEACH', mode: 'REQUEST_BASED', desc: 'A safe, empowering beach retreat exclusively for women! South Goa beachside resort, yoga on the beach, water sports, Fontainhas heritage walk, spice plantation tour, and sunset cruise. Women-led guides and all-female group. Perfect for solo women travelers and girls\' trips.', days: 4, price: 8999, early: 7499, min: 8, max: 18, booked: 10, status: 'COMPLETED', cancel: 'MODERATE', sM: 1, sD: 20, sY: 2026, incl: ['Beach resort (3N)', 'All meals', 'Beach yoga', 'Water sports', 'Fontainhas walk', 'Spice plantation', 'Sunset cruise'], excl: ['Transport to Goa', 'Alcohol'], itin: ['Arrive Goa, Beach Yoga, Welcome Dinner', 'Water Sports, Fontainhas Heritage Walk', 'Spice Plantation, Cooking Class, Sunset Cruise', 'Beach Morning & Departure'] })
  await mk({ dest: 'ladakh', orgIdx: 4, title: 'Women-Only Ladakh Road Trip — 7N/8D Empowering Himalayan Adventure', slug: 'women-only-ladakh-feb-2026', type: 'ROAD_TRIP', mode: 'REQUEST_BASED', desc: 'India\'s first all-women Ladakh road trip! Manali to Leh highway, Pangong Lake camping, Nubra Valley sand dunes, Khardung La pass, and monastery visits. Women riders and SUV options. All-female crew with medical support. Empower yourself on the world\'s highest roads.', days: 8, price: 24999, min: 6, max: 14, booked: 8, status: 'COMPLETED', cancel: 'STRICT', sM: 2, sD: 5, sY: 2026, incl: ['Hotels + camps (7N)', 'All meals', 'SUV transport', 'Pangong camping', 'Nubra Valley', 'Oxygen backup', 'Female medic'], excl: ['Flight to Manali/Leh', 'Bike rental (optional ₹2,500/day)', 'Cold weather gear'], itin: ['Manali Acclimatization Day', 'Manali to Jispa — Atal Tunnel', 'Jispa to Leh — Baralacha La', 'Leh — Shanti Stupa, Leh Palace, Market', 'Pangong Lake — Lakeside Camping', 'Nubra Valley — Sand Dunes, Diskit Monastery', 'Khardung La, Back to Leh', 'Departure'] })
  await mk({ dest: 'rishikesh', orgIdx: 4, title: 'Women-Only Rishikesh Yoga & Rafting — 2N/3D Weekend Escape from Delhi', slug: 'women-only-rishikesh-apr-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'The perfect weekend escape for women! 16 km white-water rafting, riverside yoga, cliff jumping at Brahmpuri, Ganga Aarti, and camping under the stars. All-female rafting crew, women guides, and safe camping setup. No experience needed.', days: 3, price: 4999, min: 10, max: 22, booked: 14, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 4, sD: 11, sY: 2026, incl: ['Riverside camp (2N)', 'All meals', '16 km rafting', 'Cliff jumping', 'Yoga sessions', 'Ganga Aarti', 'Bonfire'], excl: ['Bus from Delhi (₹600 Volvo)', 'Waterproof phone pouch'], itin: ['Arrive Rishikesh, Riverside Yoga, Ganga Aarti', '16 km Rafting, Cliff Jumping, Beach Games', 'Sunrise Yoga, Ram Jhula Walk & Departure'] })
  await mk({ dest: 'jaipur', orgIdx: 4, title: 'Women-Only Rajasthan Heritage Tour — 4N/5D Jaipur Udaipur Circuit', slug: 'women-only-rajasthan-may-2026', type: 'CULTURAL', mode: 'INSTANT', desc: 'A royal Rajasthan experience designed for women! Amber Fort, Hawa Mahal, City Palace Udaipur, Lake Pichola boat ride, block printing workshop, traditional Rajasthani cooking class, and shopping in Johari Bazaar. Women guides at every heritage site.', days: 5, price: 11999, early: 9999, min: 8, max: 16, booked: 6, status: 'COMPLETED', cancel: 'MODERATE', sM: 5, sD: 22, sY: 2026, incl: ['Heritage hotels (4N)', 'All meals', 'Amber Fort', 'City Palace', 'Boat ride', 'Block printing workshop', 'Cooking class', 'Transport'], excl: ['Flight to Jaipur', 'Shopping budget'], itin: ['Arrive Jaipur, Hawa Mahal, Johari Bazaar', 'Amber Fort, Block Printing Workshop', 'Drive to Udaipur, Ranakpur Jain Temple', 'City Palace, Lake Pichola, Cooking Class', 'Saheliyon ki Bari & Departure'] })
  await mk({ dest: 'meghalaya', orgIdx: 4, title: 'Women-Only Meghalaya Root Bridges — 5N/6D Northeast Explorer', slug: 'women-only-meghalaya-mar-2026', type: 'TREKKING', mode: 'REQUEST_BASED', desc: 'Explore the magical Northeast with an all-women group! Double-decker root bridge trek, crystal-clear Dawki river kayaking, Mawlynnong cleanest village, Laitlum Canyon, and Shillong café culture. Women tribal guides, safe homestays, and empowering conversations.', days: 6, price: 14999, min: 6, max: 14, booked: 3, status: 'COMPLETED', cancel: 'MODERATE', sM: 3, sD: 15, sY: 2026, incl: ['Homestays + hotels (5N)', 'All meals', 'Root bridge trek', 'Dawki kayaking', 'Mawlynnong visit', 'Shillong tour', 'Local women guides'], excl: ['Flight to Guwahati', 'Rain gear', 'Trekking shoes'], itin: ['Arrive Guwahati, Drive to Shillong', 'Laitlum Canyon, Shillong Cafes', 'Cherrapunji — Double-Decker Root Bridge Trek', 'Rainbow Falls, Mawlynnong Village', 'Dawki River Kayaking, Shnongpdeng Camp', 'Umiam Lake & Departure'] })
  await mk({ dest: 'coorg', orgIdx: 4, title: 'Women-Only Coorg Coffee & Nature Retreat — 2N/3D Weekend from Bangalore', slug: 'women-only-coorg-mar-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'A rejuvenating weekend in Karnataka\'s coffee country for women! Coffee plantation walks, Abbey Falls trek, Dubare elephant camp, Kodava cooking class, and bonfire under the stars. The ultimate self-care weekend with like-minded women.', days: 3, price: 5499, min: 8, max: 18, booked: 14, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 3, sD: 19, sY: 2026, incl: ['Plantation homestay (2N)', 'All meals', 'Coffee walk', 'Abbey Falls', 'Dubare camp', 'Cooking class', 'Bonfire'], excl: ['Transport to Coorg', 'Tips'], itin: ['Arrive Coorg, Coffee Plantation Walk, Bonfire', 'Dubare Elephant Camp, Abbey Falls Trek', 'Kodava Cooking Class & Departure'] })
  ...
  await mk({ dest: 'goa', orgIdx: 5, title: 'Corporate Team Offsite Goa — 3N/4D Beach Team Building Package from Pune', slug: 'corporate-goa-offsite-feb-2026', type: 'BEACH', mode: 'REQUEST_BASED', desc: 'India\'s most popular corporate offsite destination! Beach team building games, indoor strategy workshops, yacht party, North Goa night out, and Dudhsagar waterfall excursion. Custom agenda for your team. GST invoicing included. Trusted by 50+ companies.', days: 4, price: 12999, min: 15, max: 40, booked: 22, status: 'COMPLETED', cancel: 'MODERATE', sM: 2, sD: 6, sY: 2026, incl: ['Resort (3N)', 'All meals', 'Conference hall', 'Team building games', 'Yacht party', 'Dudhsagar trip', 'DJ night', 'GST invoice'], excl: ['Transport to Goa', 'Alcohol', 'Personal expenses'], itin: ['Arrive, Check-in, Ice-Breaker Games', 'Morning Workshop, Afternoon Beach Olympics', 'Dudhsagar Waterfall, Evening Yacht Party', 'Award Ceremony & Departure'] })
  await mk({ dest: 'lonavala', orgIdx: 5, title: 'Corporate Offsite Lonavala — 1N/2D Team Outing Package from Pune', slug: 'corporate-lonavala-outing-jan-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Quick 2-day team outing from Pune! Pawna Lake campsite, team building challenges, zip-lining, rappelling, barbecue dinner, and morning trek to Tikona Fort. Perfect for quarterly team bonding without burning too many work days.', days: 2, price: 3999, min: 15, max: 50, booked: 30, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 1, sD: 25, sY: 2026, incl: ['Campsite (1N)', 'All meals', 'Team building activities', 'Zip-line', 'Rappelling', 'BBQ dinner', 'Bonfire', 'GST invoice'], excl: ['Transport from Pune (bus available ₹500/person)'], itin: ['Arrive Pawna Lake, Team Building, Zip-Line, BBQ Night', 'Tikona Fort Morning Trek, Award Ceremony, Departure'] })
  await mk({ dest: 'rishikesh', orgIdx: 5, title: 'Corporate Adventure Retreat Rishikesh — 2N/3D Outbound Training from Delhi', slug: 'corporate-rishikesh-retreat-mar-2026', type: 'ADVENTURE', mode: 'REQUEST_BASED', desc: 'Leadership and team building through adventure! White-water rafting as a team, high-rope course, commando net, trust fall exercises, evening yoga, and Ganga Aarti. Corporate outbound training that actually builds teams. Certified facilitators and GST invoicing.', days: 3, price: 7999, min: 15, max: 40, booked: 18, status: 'COMPLETED', cancel: 'MODERATE', sM: 3, sD: 14, sY: 2026, incl: ['Resort (2N)', 'All meals', 'Rafting', 'High-rope course', 'Team challenges', 'Yoga sessions', 'Ganga Aarti', 'Facilitator', 'GST invoice'], excl: ['Bus from Delhi', 'Personal items'], itin: ['Arrive, Ice-Breakers, Evening Ganga Aarti', 'Rafting + Outbound Training Challenges', 'Sunrise Yoga, Awards, Departure'] })
  await mk({ dest: 'coorg', orgIdx: 5, title: 'Corporate Retreat Coorg — 2N/3D Plantation Stay Team Building from Bangalore', slug: 'corporate-coorg-retreat-may-2026', type: 'WEEKEND', mode: 'INSTANT', desc: 'Escape to coffee country for your next offsite! Plantation resort, outdoor team challenges, treasure hunt in the coffee estate, campfire karaoke, and nature walks. Breakout rooms for strategy sessions. Perfect for Bangalore tech teams.', days: 3, price: 6999, min: 15, max: 35, booked: 20, status: 'COMPLETED', cancel: 'FLEXIBLE', sM: 5, sD: 28, sY: 2026, incl: ['Plantation resort (2N)', 'All meals', 'Team building', 'Treasure hunt', 'Nature walk', 'Campfire', 'Conference room', 'GST invoice'], excl: ['Transport from Bangalore', 'Alcohol'], itin: ['Arrive, Team Building Games, Campfire Karaoke', 'Strategy Session, Outdoor Challenges, Coffee Walk', 'Abbey Falls Outing & Departure'] })
  await mk({ dest: 'udaipur', orgIdx: 5, title: 'Corporate Leadership Retreat Udaipur — 3N/4D Luxury Offsite Package', slug: 'corporate-udaipur-retreat-feb-2026', type: 'CULTURAL', mode: 'REQUEST_BASED', desc: 'A premium corporate leadership retreat in the City of Lakes. Lakeside strategy sessions, team building at Kumbhalgarh Fort, sunset boat ride on Lake Pichola, gala dinner at a heritage haveli, and Rajasthani cultural evening. For C-suite and leadership teams.', days: 4, price: 18999, min: 10, max: 25, booked: 8, status: 'COMPLETED', cancel: 'STRICT', sM: 2, sD: 20, sY: 2026, incl: ['Heritage hotel (3N)', 'All meals', 'Conference hall', 'Boat ride', 'Kumbhalgarh Fort trip', 'Gala dinner', 'Cultural evening', 'GST invoice'], excl: ['Flight to Udaipur', 'Personal shopping'], itin: ['Arrive, Lakeside Strategy Session, Welcome Dinner', 'Kumbhalgarh Fort Team Challenge', 'Lake Pichola Boat, City Palace, Gala Dinner', 'Closing Session & Departure'] })
  await mk({ dest: 'manali', orgIdx: 5, title: 'Corporate Snow Adventure Manali — 3N/4D Winter Team Offsite from Delhi', slug: 'corporate-manali-winter-jan-2026', type: 'ADVENTURE', mode: 'INSTANT', desc: 'Team building in the snow! Solang Valley snow activities, igloo building challenge, Atal Tunnel drive to Sissu, hot springs bonding, and Old Manali after-party. An unforgettable winter offsite for young teams.', days: 4, price: 9999, min: 15, max: 30, booked: 28, status: 'COMPLETED', cancel: 'MODERATE', sM: 1, sD: 10, sY: 2026, incl: ['Hotel (3N)', 'All meals', 'Snow activities', 'Atal Tunnel trip', 'Team games', 'Hot springs', 'Bonfire', 'GST invoice'], excl: ['Volvo bus from Delhi', 'Snow gear rental (₹500)'], itin: ['Arrive Manali, Check-in, Mall Road Walk', 'Solang Valley — Snow Games & Igloo Challenge', 'Atal Tunnel to Sissu, Hot Springs, Team Awards', 'Old Manali Breakfast & Departure'] })
...
const REVIEW_PHOTOS: Record<string, string[]> = {
  goa: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243543/seed/reviews/d8dhiyqdwouw1tki8oep.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243545/seed/reviews/tmvugmmpbsr4jxtdgpc0.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243547/seed/reviews/fjlhbr3a7ynxdlqnhqc5.jpg'],
  manali: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243549/seed/reviews/bkhwltsbhhinfjlxudcv.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243551/seed/reviews/gsbw7bw8kes9ogyxcl7z.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243553/seed/reviews/cmc62xfhq5cf6hevxxne.jpg'],
  ladakh: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243555/seed/reviews/vbp5zezc1ee5w6cfaijb.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243556/seed/reviews/gcyzstvryvz2rzhdc3hf.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243558/seed/reviews/tajwsb33ttq4as966lth.jpg'],
  rishikesh: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243560/seed/reviews/qw4an9ecvyjn7c5nhprz.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243562/seed/reviews/h9uxejtcskedy0nw0rg6.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243564/seed/reviews/cbtqhgjjljscccmtowiy.jpg'],
  jaipur: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243566/seed/reviews/vjjlzjyc0cori2a1slw4.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243568/seed/reviews/vq8g1evfknvevxlzjbmq.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243569/seed/reviews/no4jjf3lldpdylfjjl3n.jpg'],
  kasol: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243571/seed/reviews/i4zferfdxht8zzoyuiis.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243573/seed/reviews/elm91qgkifgpj1qaeazi.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243575/seed/reviews/kzax2nr38vygv9gzafz4.jpg'],
  lonavala: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243577/seed/reviews/i67b0ffkin25codj9qvg.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243579/seed/reviews/nadhydfvrbcwyxlvbzfx.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243605/seed/reviews/jfzrpnuzzdgzriaqzm5l.jpg'],
  udaipur: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243607/seed/reviews/hkgynpn2xbtdsjpronoe.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243609/seed/reviews/exskq2xrlif2ambkeu87.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243611/seed/reviews/ehnv1kewv2soob2hz1pd.jpg'],
  meghalaya: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243613/seed/reviews/zc57izmdmplimikquwpj.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243615/seed/reviews/nam9u6czuqjfdew9datm.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243617/seed/reviews/vhfeleh2xxvupto09vjz.jpg'],
  hampi: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243619/seed/reviews/o26tcrvakdkj9bgb5zrs.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243621/seed/reviews/fu67qkr92ll1xofxs15p.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243623/seed/reviews/uot66nppairr6wvt6mqv.jpg'],
  spiti: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243624/seed/reviews/jaxf7hjz0bhvbxdablhk.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243626/seed/reviews/elucyaqmebgcp5begnlc.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243628/seed/reviews/ms5xjciwcpp6e02ijkwr.jpg'],
  'spiti-valley': ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243624/seed/reviews/jaxf7hjz0bhvbxdablhk.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243626/seed/reviews/elucyaqmebgcp5begnlc.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243628/seed/reviews/ms5xjciwcpp6e02ijkwr.jpg'],
  coorg: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243629/seed/reviews/lafwpdtapcmysksfpmgp.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243631/seed/reviews/pobtgqgbdwoatnwmcrj0.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243633/seed/reviews/wkfhprnpuhmcc5dh4qa7.jpg'],
  varanasi: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243635/seed/reviews/bc5boa6kb3khkl8tvcsk.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243637/seed/reviews/jdvgsbubt30niqmjdaes.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243639/seed/reviews/slbiv0ew3wbrng6x6cf7.jpg'],
  andaman: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243641/seed/reviews/utaixnfn3v3ltuhqocz9.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243643/seed/reviews/q2wwyiswdbxwwjso8rwt.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243645/seed/reviews/dzkqqmuzjs27tu1jg635.jpg'],
  dharamshala: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243647/seed/reviews/opevcipucr9pnaowkqlh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243650/seed/reviews/ok7ualapdwlb6xk1jrq4.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243652/seed/reviews/zfgpik1oz1npo4zwob6m.jpg'],
  ooty: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243654/seed/reviews/thn5n66pqwortoaapsaf.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243656/seed/reviews/ribth1p6pkefycajhazw.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243658/seed/reviews/vvbd33dprdtspe6h9uie.jpg'],
  rannOfKutch: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243659/seed/reviews/pwik1gpefezohs9uzrkv.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243661/seed/reviews/uevorc9mdydqjq0vo3ry.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243663/seed/reviews/hhvprvywosajwgywl8fg.jpg'],
  'rann-of-kutch': ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243659/seed/reviews/pwik1gpefezohs9uzrkv.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243661/seed/reviews/uevorc9mdydqjq0vo3ry.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243663/seed/reviews/hhvprvywosajwgywl8fg.jpg'],
}
...
const REVIEW_TEMPLATES = [
  ...
  { overall: 5, org: 5, val: 5, safe: 5, acc: 5, comment: 'Went as a solo female traveler and felt completely safe the entire time! The organizer created such a welcoming atmosphere from day one — within hours I made friends I am still in touch with. The women in the group were especially supportive. Safarnama\'s SafePay protection gave me confidence to book. Best decision of 2025!' },
...
async function seedNotifications(adminId: string, organizerId: string, travelerId: string) {
  ...
  const notifications: Prisma.NotificationCreateManyInput[] = [
    ...
    { userId: travelerId, channel: 'IN_APP', type: 'CHAT_MESSAGE', title: 'New message from Rajesh', body: 'Rajesh Khandelwal: "Hi! Pickup point is Shivaji Nagar Bus Stand, 8 PM sharp."', data: { conversationId: 'seed-conv-1' }, sentAt: ago(10), createdAt: ago(10) },
    { userId: travelerId, channel: 'IN_APP', type: 'TRIP_REQUEST_APPROVED', title: 'Trip Request Approved!', body: 'Your request to join Ladakh Bike Expedition has been approved. Complete payment within 48h.', data: { tripSlug: 'ladakh-bike-expedition-jan-2026' }, sentAt: ago(60), createdAt: ago(60) },
    ...
    // ── ORGANIZER (rajesh@desiwanderers.in) ──
    { userId: organizerId, channel: 'IN_APP', type: 'TRIP_REQUEST_RECEIVED', title: 'New Trip Request', body: 'Amit Kulkarni wants to join your Ladakh Bike Expedition. Review and respond.', data: { tripSlug: 'ladakh-bike-expedition-jan-2026', travelerName: 'Amit Kulkarni' }, sentAt: ago(90), createdAt: ago(90) },
    ...
    { userId: organizerId, channel: 'IN_APP', type: 'ORGANIZER_APPROVED', title: 'Profile Approved!', body: 'Congratulations! Your organizer profile "Desi Wanderers" has been approved. Start creating trips!', data: { profileId: 'seed-profile-1' }, readAt: ago(40000), sentAt: ago(43200), createdAt: ago(43200) },
    ...
    { userId: adminId, channel: 'IN_APP', type: 'SYSTEM_ALERT', title: 'New Organizer Pending', body: 'Vikram Deshpande from "Sahyadri Trekkers Club" submitted an organizer application. Review it.', data: { profileId: 'seed-pending-1' }, sentAt: ago(45), createdAt: ago(45) },
    ...
    { userId: adminId, channel: 'IN_APP', type: 'ORGANIZER_REJECTED', title: 'Organizer Rejected', body: 'Neha Grover\'s application for "Budget Yatris India" was rejected — incomplete bank details.', data: { profileId: 'seed-rejected-1' }, readAt: ago(5000), sentAt: ago(10080), createdAt: ago(10080) },
...
async function seedTripCategoriesAndRequests(deps: {
  ...
  await safeTypeReqCreate({ data: {
    ...
    reason: 'Nomadic Trails India runs dedicated food-focused trips — Jaipur street food crawls, Varanasi kachori trails, Lucknow kebab walks. The food experience IS the trip, not a side activity. A "Food Trail" category would be a huge differentiator for the platform.',
    status: 'APPROVED',
  ...
  await safeTypeReqCreate({ data: {
    ...
    reason: 'Rucksack Bharat runs special trips around Indian festivals — Holi in Mathura, Diwali in Varanasi, Rann Utsav in Kutch, Pushkar Camel Fair. These are time-sensitive, festival-themed experiences that don\'t fit existing categories.',
    status: 'APPROVED',
  ...
  await safeTypeReqCreate({ data: {
    ...
    reason: 'Nomadic Trails runs photography-focused trips with pro photographers — golden hour shoots, composition workshops, photo walks. A dedicated category would attract photography enthusiasts.',
    status: 'REJECTED',
  ...
  await safeTypeReqCreate({ data: {
    ...
    reason: 'Rucksack Bharat partners with NGOs for voluntourism trips — teaching English in rural schools, beach cleanups in Goa, wildlife conservation in Jim Corbett. These deserve their own category.',
    status: 'PENDING',
  ...
  await safeTypeReqCreate({ data: {
    ...
    reason: 'Nomadic Trails runs dedicated stargazing trips to dark-sky locations — Spiti, Rann of Kutch, Coorg. Telescopes, astrophotography workshops, overnight camping under the stars.',
    status: 'PENDING',
  ...
  await safeEditHistCreate({ data: {
    ...
    snapshot: { photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243665/seed/trips/of2yqfc0jibgiv8hwd4q.jpg'], itinerary: [{ day: 1, title: 'Arrive Rishikesh' }] },
  ...
  const resellers: ResellerSeed[] = [
    {
      ...
      trips: [
        {
          slug: 'goa-beach-escape-apr-2026',
    ...
    },
    {
      ...
      trips: [
        ...
        {
          slug: 'rishikesh-rafting-bungee-may-2026',
