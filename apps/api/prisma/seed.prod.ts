...
async function seedCompletedTrips(deps: Record<string, { id: string }>) {
  ...
  const tripC1 = await upsertTrip('goa-beach-carnival-jan-2026', {
      ...
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243413/seed/trips/cn9wpqfkp8xhhkxrqv0i.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243415/seed/trips/vadkycd3rwfui92wk9qn.jpg'],
  ...
  const tripC2 = await upsertTrip('manali-snow-adventure-feb-2026', {
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243416/seed/trips/nozdq6aqn3v4eziecuyl.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243417/seed/trips/n2lpqyri7nbedmatwbt2.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripC3 = await upsertTrip('rishikesh-rafting-camping-feb-2026', {
      ...
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243419/seed/trips/bpzpf2f5cruehbxc6viu.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243421/seed/trips/pwrtbuuwfkzimanflj4k.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripC4 = await upsertTrip('jaipur-heritage-experience-mar-2026', {
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243423/seed/trips/hg0zfjsgl8dj0skqzmpv.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243424/seed/trips/lecgtowcobbog0rzxzkm.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
...
async function seedUpcomingTrips(deps: Record<string, { id: string }>) {
  ...
  const tripU1 = await upsertTrip('kasol-kheerganga-trek-jun-2026', {
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243439/seed/trips/apxyfaxa6ujnog0i5dyj.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243442/seed/trips/gh3qpj5qka2my9qk6ogq.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU2 = await upsertTrip('spiti-valley-circuit-jun-2026', {
      ...
      cancellationPolicy: 'STRICT',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243443/seed/trips/yx0eqw0kwot4glcgy562.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243445/seed/trips/sssmjyiwjzoe13hsn00z.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
  })
  ...
  const tripU3 = await upsertTrip('udaipur-city-of-lakes-apr-2026', {
      ...
      exclusions: ['Train/flight tickets', 'Lunch', 'Shopping', 'Travel insurance'],
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243447/seed/trips/bgypvmikg5gfjvveapw4.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243448/seed/trips/yzcpolhrz6t0jgmyxnem.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU4 = await upsertTrip('coorg-coffee-plantation-apr-2026', {
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243449/seed/trips/oz4c9xk7wxlfbet1ayye.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243451/seed/trips/lyxt8zgkpltfgxzndixa.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU5 = await upsertTrip('varanasi-spiritual-immersion-may-2026', {
      ...
      cancellationPolicy: 'MODERATE',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243453/seed/trips/yyyldfoa9hbslcuyblu1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243455/seed/trips/r4njcwyzvhqpwzqlmbyq.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
    }, [
  ...
  const tripU6 = await upsertTrip('andaman-beach-scuba-jun-2026', {
      ...
      cancellationPolicy: 'STRICT',
      photos: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243456/seed/trips/tpmo4gbcmvoq0rswxbu2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243458/seed/trips/nftzjg8uvh4npjemgwtf.jpg'],
      status: 'COMPLETED', acceptingBookings: false,
  })
...
async function seedBookingsAndReviews(deps: {
  ...
  const reviewPhotos = [
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243463/seed/trips/qcvqamcaozwzpm08xdk2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243464/seed/trips/qilhsjz0af0u2y7rydc2.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243463/seed/trips/qcvqamcaozwzpm08xdk2.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243464/seed/trips/qilhsjz0af0u2y7rydc2.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243463/seed/trips/qcvqamcaozwzpm08xdk2.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243464/seed/trips/qilhsjz0af0u2y7rydc2.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243464/seed/trips/qilhsjz0af0u2y7rydc2.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243467/seed/trips/n1d1fglhxzozkzmxpe2s.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243468/seed/trips/qlfpif5pdyvuyxpwkonh.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243467/seed/trips/n1d1fglhxzozkzmxpe2s.jpg'],
    [],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243467/seed/trips/n1d1fglhxzozkzmxpe2s.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243468/seed/trips/qlfpif5pdyvuyxpwkonh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243470/seed/trips/rxv6zx8amryqwdayughk.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243467/seed/trips/n1d1fglhxzozkzmxpe2s.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243472/seed/trips/q9vrml5mhcay19hrvwri.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243473/seed/trips/nwaavtoy91ayuuotss6y.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243472/seed/trips/q9vrml5mhcay19hrvwri.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243472/seed/trips/q9vrml5mhcay19hrvwri.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243473/seed/trips/nwaavtoy91ayuuotss6y.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243472/seed/trips/q9vrml5mhcay19hrvwri.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243477/seed/trips/awcjwvdmde1bgnkhdlre.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243478/seed/trips/w4raotvn42lli13bjxp1.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243477/seed/trips/awcjwvdmde1bgnkhdlre.jpg'],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243478/seed/trips/w4raotvn42lli13bjxp1.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243477/seed/trips/awcjwvdmde1bgnkhdlre.jpg'],
    [],
    ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243477/seed/trips/awcjwvdmde1bgnkhdlre.jpg'],
    [],
  ]
...
const DEST_PHOTOS: Record<string, string[]> = {
  goa: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243386/seed/destinations/zaklapq4u38dpchpwlf4.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243480/seed/trips/jby9xuggljkd5hxhrvjh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243481/seed/trips/gj7x61vxpyze9ro094dr.jpg'],
  manali: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243387/seed/destinations/rwjp0z5obcvlygxpvhrb.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243483/seed/trips/jszmu5fgk9zifwcrmhdj.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243485/seed/trips/vx6zohtlcasibb4zjpzc.jpg'],
  ladakh: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243389/seed/destinations/qa4l3fntxmwryv94tk8w.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243487/seed/trips/llrd2yzonjddeebbv6n8.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243489/seed/trips/cq7r8njktp9g8gkcybcv.jpg'],
  rishikesh: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243390/seed/destinations/knljydussngiqxlnqhbm.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243491/seed/trips/wj1tmcaa04v29uouu2ad.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243494/seed/trips/tyqoopvnyssev5hoodh3.jpg'],
  jaipur: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243391/seed/destinations/td3seeqifvlrfoth3ztc.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243496/seed/trips/wjrezypq0inkqeg5unmh.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243498/seed/trips/h0zmrujb2fagklqjlurj.jpg'],
  kasol: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243393/seed/destinations/t0cnzidrpimni3snzpxf.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243500/seed/trips/dratmfmnwddh3tnhgp2p.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243501/seed/trips/earnjrxxrqm4ojgen8dc.jpg'],
  lonavala: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243400/seed/destinations/ncvt8ytjry03mrio6mzl.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243503/seed/trips/ud0yjvm7wkuaelty33xj.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243504/seed/trips/xzmn7iampl7xlzhcjcit.jpg'],
  udaipur: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243395/seed/destinations/ojeqlpgiqh1x7z1mgeno.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243506/seed/trips/uwr1lodzrfcjd9l5khyo.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243508/seed/trips/nttgzbktac4u85c3xnlv.jpg'],
  meghalaya: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243396/seed/destinations/w2cctn6ra67ktvrdbytn.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243509/seed/trips/ia2diufdoxuqjkg8pwm5.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243511/seed/trips/eoanc77nhrprjfiaxhem.jpg'],
  hampi: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243398/seed/destinations/z1ybo7gdwjlzojtz3erl.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243513/seed/trips/lzmkv1favtmos3gyq3r6.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243515/seed/trips/gjzqnorwdyoldlsdneoj.jpg'],
  spiti: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243401/seed/destinations/ophe4q5e6pkp5mdmmcco.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243517/seed/trips/pfvx0bzrz1lhtoah0sqk.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243519/seed/trips/flnlqiqhiufwkuhbxx9a.jpg'],
  coorg: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243403/seed/destinations/ps0assfifuavmcskkmso.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243521/seed/trips/ziodxwdcf9mecjzv6mpb.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243523/seed/trips/z5io6lfuqvxsfw61l5em.jpg'],
  varanasi: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243404/seed/destinations/yhhcjwury3eqx0f7vvqk.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243525/seed/trips/gzaecdtqpb5d5vk04jpp.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243526/seed/trips/lvch3anngp8tkripbxnw.jpg'],
  andaman: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243406/seed/destinations/r3ozpftp0egzgucys4aw.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243529/seed/trips/masfwhtw6mlzq3nuzqp3.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243531/seed/trips/xae6lmirbn08npntep0o.jpg'],
  dharamshala: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243408/seed/destinations/mez9hlgfarjg7votqfqt.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243533/seed/trips/mtjd4udygerpsitoslpa.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243535/seed/trips/lqspifskvxdjursbgfz9.jpg'],
  ooty: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243409/seed/destinations/zdz4apjsary22ky8txvq.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243537/seed/trips/oolonwrilqrfizqha8wm.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243539/seed/trips/jyahpyywuuedmebc7lyt.jpg'],
  rannOfKutch: ['https://res.cloudinary.com/dhng8qau8/image/upload/v1782243411/seed/destinations/mu6bevx5vfjdjlwkk8oy.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243540/seed/trips/kxgjcgg71dlnragcctzw.jpg', 'https://res.cloudinary.com/dhng8qau8/image/upload/v1782243542/seed/trips/lrxdtf7ivczp7ldd6eng.jpg'],
}
