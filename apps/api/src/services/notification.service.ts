...
const DEFAULT_CHANNELS: Record<NotificationType, NotificationChannel[]> = {
  ...
  TRIP_TYPE_REQUEST_APPROVED: [NOTIFICATION_CHANNEL.IN_APP, NOTIFICATION_CHANNEL.EMAIL],
  TRIP_TYPE_REQUEST_REJECTED: [NOTIFICATION_CHANNEL.IN_APP],
  DOCUMENT_REUPLOAD_REQUIRED: [NOTIFICATION_CHANNEL.IN_APP, NOTIFICATION_CHANNEL.EMAIL],
  WALLET_CREDIT_EXPIRING: [NOTIFICATION_CHANNEL.IN_APP, NOTIFICATION_CHANNEL.EMAIL],
}
